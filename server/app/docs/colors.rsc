...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Colors"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"CSS color names and hex, and why a case named \"gold\" never collides."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Any ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," property accepts:"]}],"\n",["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"A standard CSS color name"}]," — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"white"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"black"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"red"}],", ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"gold"}],", ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"teal"}],", ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"grey"}],",\n",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"mediumpurple"}],", ",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"hotpink"}],", ",["$","code","code-8",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"darkslateblue"}],", … all 148 of them."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Hex"}]," — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#ff0000"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#1a2b3c"}],". Six digits, always."]}],"\n"]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Rectangle:\n  x: 0\n  y: 0\n  width: full\n  height: 3\n  color: mediumpurple\n"}]}],"\n",["$","h2","h2-0",{"id":"colors-from-data","aria-label":"Colors from data","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Colors from data",["$","a",null,{"href":"#colors-from-data","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-1",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," is an ",["$","$L5","a-0",{"href":"/docs/expressions","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"expression"}]," like any other, so it can depend on the\ncard:"]}],"\n","$L2e","\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39"]}],"$L3a"]}]
2e:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"color: if [cost] > 3 then gold else grey\n"}]}]
2f:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"color: if [current_suit] == Suit.Rock then grey\n       else if [current_suit] == Suit.Paper then gold\n       else mediumpurple\n"}]}]
30:["$","h2","h2-1",{"id":"images-and-part-of-a-text","aria-label":"Images and part of a text","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Images and part of a text",["$","a",null,{"href":"#images-and-part-of-a-text","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
31:["$","p","p-2",{"className":"my-4","children":["On an ",["$","$L5","a-0",{"href":"/docs/images","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}]}],", ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," is a multiply tint rather than a flat fill:\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"white"}]," (the default) leaves the art unchanged, white source pixels become the chosen\ncolor, and darker source detail stays darker. Source transparency is preserved."]}]
32:["$","p","p-3",{"className":"my-4","children":["Inside ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],", nested ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{color:red}…{/color}"}]," tags can override the\nelement's whole-text ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," for selected words and inline icons without affecting\nwrapping. See ",["$","$L5","a-0",{"href":"/docs/text#scoped-colors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Scoped colors"}]," for the syntax and its raw-text\nfailure behavior."]}]
33:["$","h2","h2-2",{"id":"names-only-mean-colors-in-color-positions","aria-label":"Names only mean colors in color positions","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Names only mean colors in color positions",["$","a",null,{"href":"#names-only-mean-colors-in-color-positions","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
34:["$","p","p-4",{"className":"my-4","children":["A bare word is read against the type expected in that position. In a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," property\nthat's the CSS palette; elsewhere it isn't. So an enum case named ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"gold"}]," and the color\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"gold"}]," can coexist without ambiguity:"]}]
35:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Enum: Metal\n  case gold      # perfectly legal\n  case silver\n\n# ...compared as an enum case here:\ncolor: if [metal] == Metal.gold then gold else silver\n#                                    ^^^^ the color   ^^^^^^ the color\n"}]}]
36:["$","h2","h2-3",{"id":"watch-out-for","aria-label":"Watch out for #","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[["Watch out for ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#"}]],["$","a",null,{"href":"#watch-out-for","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","p","p-5",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#"}]," starts a comment — ",["$","em","em-0",{"children":"except"}]," when it's followed by exactly six hex digits, where\nit's a color literal. Don't open a comment with something like ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#ff0000"}],"."]}]
38:["$","h2","h2-4",{"id":"printing","aria-label":"Printing","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Printing",["$","a",null,{"href":"#printing","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
39:["$","p","p-6",{"className":"my-4","children":["Colors are emitted to PDF as-is in RGB. There's no CMYK conversion, no color\nmanagement, and no bleed handling yet — for home printing and prototypes that's fine;\nfor a print shop, check with them first. Print specifics are on the\n",["$","$L5","a-0",{"href":"/docs/roadmap","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"roadmap"}],"."]}]
3a:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/card-sizes","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Card sizes"}]]}],["$","$L5",null,{"href":"/docs/icons","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Icons"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3b:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Colors — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"CSS color names and hex, and why a case named \"gold\" never collides."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/colors"}],["$","meta","6",{"property":"og:title","content":"Colors — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"CSS color names and hex, and why a case named \"gold\" never collides."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/colors"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Colors — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"CSS color names and hex, and why a case named \"gold\" never collides."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3b","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
