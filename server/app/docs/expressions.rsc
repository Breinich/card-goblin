...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Expressions"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Arithmetic, comparisons, logic, and if/then/else — anywhere a value goes."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Anywhere a value goes, an expression can go. ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: 4"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: 1.5 + [i] * 2"}]," are the\nsame kind of thing."]}],"\n",["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Kind"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Examples"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Arithmetic"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[cost] + 1"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"2 * [i]"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[atk] % 3"}],", parentheses"]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Comparison"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"=="}]," ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"!="}]," on matching types; ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"<"}]," ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"<="}]," ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":">"}]," ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":">="}]," on numbers only"]}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Logic"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"and"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"or"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"not"}]]}]]}],"$L2e","$L2f","$L30"]}]]}]}],"\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41","\n","$L42","\n","$L43","\n","$L44","\n","$L45","\n","$L46","\n","$L47","\n","$L48","\n","$L49","\n","$L4a"]}],"$L4b"]}]
2e:["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Conditional"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"if [cost] > 3 then gold else grey"}]}]]}]
2f:["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Enum cases"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Suit.Rock"}]," always; bare ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Rock"}]," when it's unambiguous"]}]]}]
30:["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Collection membership"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"contains([tags], CardTag.Fire)"}]}]]}]
31:["$","h2","h2-0",{"id":"conditionals","aria-label":"Conditionals","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Conditionals",["$","a",null,{"href":"#conditionals","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","p","p-1",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"if … then … else …"}]," is an ",["$","em","em-0",{"children":"expression"}],", not a statement — it produces a value, so\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"else"}]," is always required:"]}]
33:["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"color: if [current_suit] == Suit.Rock then grey\n       else if [current_suit] == Suit.Paper then gold\n       else mediumpurple\n"}]}]
34:["$","p","p-2",{"className":"my-4","children":["Chain as many ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"else if"}],"s as you like. Both branches must produce the same type — you\ncan't return a color from one and a number from the other."]}]
35:["$","p","p-3",{"className":"my-4","children":["To conditionally draw whole shapes, use capitalized structural ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}],"/",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}]," instead:"]}]
36:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"If: [is_rare]\n  Text:\n    text: \"Rare\"\nElse:\n  CommonBadge:\n"}]}]
37:["$","p","p-4",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}]," is optional and must immediately follow its ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}]," at the same indentation.\nBoth branches are checked, but only the selected branch runs; the other produces no\nshapes or data errors. Put a nested ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}]," inside ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}]," for else-if."]}]
38:["$","h2","h2-1",{"id":"named-values-with-let","aria-label":"Named values with let","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[["Named values with ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]],["$","a",null,{"href":"#named-values-with-let","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
39:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"let accent: #cc0000\n\nTemplate: CardFront\n  let title_size: 3.5\n  Text:\n    x: 0\n    y: 0\n    color: [accent]\n    size: [title_size]\n    text: \"Title\"\n"}]}]
3a:["$","p","p-5",{"className":"my-4","children":["A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," is immutable and type-inferred. Global lets can use the current Card's data;\nlocal lets can use their lexical parents. Same-block lets may refer forward. Values\nare lazy, so an unused let and a let in an unselected branch do not read cells or\nproduce data errors. Use a self-typing color (",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#RRGGBB"}],") or qualified enum case\n(",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Suit.Rock"}],") when no surrounding property supplies an expected type."]}]
3b:["$","p","p-6",{"className":"my-4","children":["A top-level let that resolves to Text can also be inserted into ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],"\nresolved text with ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}],". This is a one-level reuse mechanism for fragments\nthat contain ",["$","$L5","a-0",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"inline icons, assets, or scoped colors"}],",\nnot another expression lookup: local lets, parameters, non-Text lets, and unknown\nor statically invalid/unpreparable targets are left as the raw marker with a\nnon-fatal D011 data diagnostic. Runtime data errors from an otherwise valid Text\nalias propagate exactly as they do for an ordinary let reference; D003, for example,\nstill makes the affected card a placeholder. Because an alias name can arrive from\na spreadsheet cell, a top-level let that validly resolves to Text for at least one\nCard (or without Card data), and\nthe globals it depends on, are externally addressable and do not receive W002\n\"never used\". This compiler-level alias-export status makes the let available to\nresolved text and affects unused-binding checks; it does not add the let to\nspreadsheet or CSV data exports."]}]
3c:["$","h2","h2-2",{"id":"types","aria-label":"Types","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Types",["$","a",null,{"href":"#types","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3d:["$","p","p-7",{"className":"my-4","children":["There are ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Number"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Bool"}],", ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Color"}],", one type per Enum you declare, and\n",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}],"/",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}]," collection types.\nChecking happens as you type, so mistakes squiggle rather than producing odd cards:"]}]
3e:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":"arithmetic needs numbers,"}],"\n",["$","li","li-1",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"=="}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"!="}]," need both sides to be the ",["$","em","em-0",{"children":"same"}]," type,"]}],"\n",["$","li","li-2",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"<"}]," ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"<="}]," ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":">"}]," ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":">="}]," are ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"numbers only"}]," — there's no meaningful ordering on text or\nenum cases,"]}],"\n",["$","li","li-3",{"children":["an ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"if"}]," condition must be a Bool."]}],"\n"]}]
3f:["$","p","p-8",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"contains(collection, case)"}]," works with both Sets and Lists and produces Bool. The\ncase must come from the collection's Enum. Collections may pass through ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}],",\nTemplate parameters, and same-typed ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"if"}]," branches, but they cannot be compared or\nautomatically converted to Text. Collection literals and mutation are not part of\nGoblin Script; collection values originate in sheet data."]}]
40:["$","p","p-9",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Comparisons don't chain."}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"a == b == c"}]," is an error — write ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"a == b and b == c"}],"."]}]
41:["$","p","p-10",{"className":"my-4","children":["The one automatic conversion: in a text position (",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text:"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"code:"}],", or inside string\ninterpolation) numbers and enum cases become text. That's what makes ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text: [cost]"}],"\nwork."]}]
42:["$","p","p-11",{"className":"my-4","children":["Quoted strings have one Number-specific formatting form: ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name:0N]"}]," zero-pads to a\nminimum total width ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"N"}]," from 1 through 64. It includes a minus sign in that width and\nnever rounds or truncates. See ",["$","$L5","a-0",{"href":"/docs/sheets-and-data","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Interpolation"}]," for examples and\nthe exact spelling rules. It does not change ordinary ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name]"}]," coercion."]}]
43:["$","h2","h2-3",{"id":"bare-names","aria-label":"Bare names","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Bare names",["$","a",null,{"href":"#bare-names","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
44:["$","p","p-12",{"className":"my-4","children":"A bare word resolves against whatever type is expected in that position:"}]
45:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["in a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," property → a ",["$","$L5","a-0",{"href":"/docs/colors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"CSS color name"}],","]}],"\n",["$","li","li-1",{"children":"compared against an enum-typed reference → that enum's cases,"}],"\n",["$","li","li-2",{"children":["in a geometry position → ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"full"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"half"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"middle"}],", ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}],"."]}],"\n"]}]
46:["$","p","p-13",{"className":"my-4","children":["So an enum case named ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"gold"}]," never collides with the color ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"gold"}]," — position decides.\nWhere no expected type is available, a bare case resolves only if it's unique across\nall your enums; otherwise qualify it as ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Suit.Rock"}],"."]}]
47:["$","h2","h2-4",{"id":"precedence","aria-label":"Precedence","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Precedence",["$","a",null,{"href":"#precedence","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
48:["$","p","p-14",{"className":"my-4","children":"Lowest to highest:"}]
49:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"if/then/else  →  or  →  and  →  not  →  comparisons  →  + -  →  * / %  →  unary -\n"}]}]
4a:["$","p","p-15",{"className":"my-4","children":"Parentheses work as you'd expect."}]
4b:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/qr-codes","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"QR codes"}]]}],["$","$L5",null,{"href":"/docs/cards-and-generation","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Cards & generation"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
4c:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Expressions — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Arithmetic, comparisons, logic, and if/then/else — anywhere a value goes."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/expressions"}],["$","meta","6",{"property":"og:title","content":"Expressions — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Arithmetic, comparisons, logic, and if/then/else — anywhere a value goes."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/expressions"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Expressions — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Arithmetic, comparisons, logic, and if/then/else — anywhere a value goes."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L4c","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
