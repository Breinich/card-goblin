...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Current limits"}],["$","span",null,{"title":"This is shipped but still moving — details may change.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-amber-800 bg-amber-950 text-amber-300 ","children":"Evolving"}]]}],["$","p",null,{"className":"text-gray-400","children":"What CardGoblin can't do yet, so you find out here and not mid-project."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":"CardGoblin is young and moving. These are the walls you're most likely to hit — better\nto read them now than to discover them three hours into a deck."}],"\n",["$","h2","h2-0",{"id":"text","aria-label":"Text","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Text",["$","a",null,{"href":"#text","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," is one line by design"]}]," — long text runs off the card rather than\nflowing. Wrapped, multi-line text is what\n",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]}]," is for."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"No bold/italic spans yet."}]," A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," can mix scoped colors and inline\nDicier/uploaded-asset icons, but font face and size still apply to the whole\nelement."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Bundled fonts only."}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," offer nine bundled faces through\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}],". Uploading an arbitrary font file is not supported yet."]}],"\n"]}],"\n",["$","h2","h2-1",{"id":"images","aria-label":"Images","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Images",["$","a",null,{"href":"#images","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"2 MB"}]," per uploaded asset. The ",["$","$L5","a-0",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Assets drawer"}]," caps\neach upload — plenty for print-resolution card art, not a place for\nfull-resolution photography."]}],"\n","$L2e","\n"]}],"\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38"]}],"$L39"]}]
2e:["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"PDF embedding needs CORS for URL art."}]," An image displays in the preview from\nany URL, but embedding a URL image into an exported PDF requires the host to\nallow cross-origin use — see ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}],". Hosts that don't\ncooperate print as placeholder boxes. Uploaded assets don't have this\nlimitation — they always embed, since the art never leaves your browser."]}]
2f:["$","h2","h2-2",{"id":"persistence","aria-label":"Persistence","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Persistence",["$","a",null,{"href":"#persistence","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
30:["$","ul","ul-2",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"One save slot per browser."}]," Your project ",["$","$L5","a-0",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"autosaves"}]," and survives\nreloads, and ",["$","$L5","a-1",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project files"}]," cover backup and moving between\nbrowsers — but the autosave slot is singular, so two open editor tabs overwrite\neach other (the last one to change wins)."]}],"\n"]}]
31:["$","h2","h2-3",{"id":"size-caps","aria-label":"Size caps","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Size caps",["$","a",null,{"href":"#size-caps","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","ul","ul-3",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"500 structural iterations per card."}]," Every iteration of every ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," and\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," counts, including nested outer and inner iterations."]}],"\n",["$","li","li-1",{"children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["2,000 physical cards per ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block."]}]}],"\n"]}]
33:["$","p","p-1",{"className":"my-4","children":"Both exist so a typo in a data cell can't hang the editor, but their failure posture\ndiffers. Crossing the shared iteration budget is D004 and makes the affected card an error\nplaceholder — no partially truncated face is kept. Crossing the physical-card cap is\nD007 and truncates that Card block with a note."}]
34:["$","h2","h2-4",{"id":"printing","aria-label":"Printing","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Printing",["$","a",null,{"href":"#printing","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","ul","ul-4",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":"Colors are RGB; no CMYK conversion or color management."}],"\n",["$","li","li-1",{"children":"No bleed or safe-zone guides — cut lines and crop marks only."}],"\n",["$","li","li-2",{"children":["A card bigger than the page can't be split across sheets — ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"export"}],"\nreports it instead of tiling it."]}],"\n"]}]
36:["$","h2","h2-5",{"id":"editing","aria-label":"Editing","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Editing",["$","a",null,{"href":"#editing","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","ul","ul-5",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"No shared undo."}]," The code editor and the spreadsheet keep separate undo\nhistories — Ctrl+Z in one never rewinds the other."]}],"\n"]}]
38:["$","p","p-2",{"className":"my-4","children":["Most of these are on the ",["$","$L5","a-0",{"href":"/docs/roadmap","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"roadmap"}]," in some form. If one of these is\nblocking you, that's useful signal — say so."]}]
39:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/assets","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Uploaded assets"}]]}],["$","$L5",null,{"href":"/docs/roadmap","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Roadmap"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3a:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Current limits — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"What CardGoblin can't do yet, so you find out here and not mid-project."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/limits"}],["$","meta","6",{"property":"og:title","content":"Current limits — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"What CardGoblin can't do yet, so you find out here and not mid-project."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/limits"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Current limits — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"What CardGoblin can't do yet, so you find out here and not mid-project."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3a","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
