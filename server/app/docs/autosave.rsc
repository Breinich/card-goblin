...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Autosave"}],["$","span",null,{"title":"This is shipped but still moving — details may change.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-amber-800 bg-amber-950 text-amber-300 ","children":"Evolving"}]]}],["$","p",null,{"className":"text-gray-400","children":"Your project saves itself in this browser — what persists, when, and the limits."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Your project — the code and every spreadsheet row — saves itself to this browser as\nyou work, and comes back when you reopen ",["$","$L5","a-0",{"href":"/docs/the-editor","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"the editor"}],". There is no\nsave button and nothing to configure."]}],"\n",["$","h2","h2-0",{"id":"what-saves-and-when","aria-label":"What saves, and when","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["What saves, and when",["$","a",null,{"href":"#what-saves-and-when","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"What:"}]," your Goblin script and all sheet rows, including which rows you've\ntouched — so dimmed pristine rows come back dimmed."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"When:"}]," about ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"1 second"}]," after your last change, and immediately when you\nswitch away from the tab or close the page."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Where:"}]," this browser profile on this machine, in ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"localStorage"}],". The public\neditor does not upload it."]}],"\n"]}],"\n",["$","p","p-1",{"className":"my-4","children":"What you had is what you get back. If you reload mid-edit with broken code, the\neditor restores the broken code, squiggles and all — not some older working version."}],"\n",["$","h2","h2-1",{"id":"uploaded-assets-save-differently","aria-label":"Uploaded assets save differently","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Uploaded assets save differently",["$","a",null,{"href":"#uploaded-assets-save-differently","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-2",{"className":"my-4","children":["Images you upload through the ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Assets"}]," drawer aren't part of the save above. They\nwrite to IndexedDB ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"the moment you upload them"}],", not on the 1-second debounce, and\nsurvive a reload. Opening or importing another project switches its code, sheets,\nand asset library together, even though those are separate stores under the hood.\nThat is also why an old, asset-free project file opens with no uploads — see\n","$L2e","."]}],"\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34"]}],"$L35"]}]
2e:["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Project files"}]
2f:["$","h2","h2-2",{"id":"cache-is-not-storage","aria-label":"Cache is not storage","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Cache is not storage",["$","a",null,{"href":"#cache-is-not-storage","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
30:["$","p","p-3",{"className":"my-4","children":["The compiled preview is kept in memory and disappears when the page closes. Your\nbrowser may also cache CardGoblin's own JavaScript, fonts, icons, and other static\nfiles as it would for any website. That HTTP cache can make the app load faster, but\nit does not contain the authoritative copy of your project and does not move work\nbetween browsers. Browser settings often group cache, cookies, localStorage, and\nIndexedDB under ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"site data"}],"; clearing all site data removes the autosave and\nuploaded assets."]}]
31:["$","h2","h2-3",{"id":"new-open-project","aria-label":"New / Open Project","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["New / Open Project",["$","a",null,{"href":"#new-open-project","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","p","p-4",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"New / Open Project"}]," in the status bar returns to the project chooser. The active\nproject stays untouched while the chooser is open and until another project finishes\nloading. Use ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Cancel"}]," to keep editing it."]}]
33:["$","h2","h2-4",{"id":"the-limits","aria-label":"The limits","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The limits",["$","a",null,{"href":"#the-limits","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
34:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Browser-local means this browser."}]," Another browser, another device, or a\nprivate window cannot read a local project. To move local work across, export\nand import ",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project files"}],"."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Two tabs fight."}]," With the editor open in two tabs, the tab that changed last\nwins; the other tab's changes are gone on its next load."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"It's browser storage, not a backup."}]," Clearing site data deletes the project.\nFor anything you'd mind losing, export a ",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project file"}],"."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Private mode may turn it off."}]," If the browser refuses storage, the status bar\nshows a quiet ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"autosave off"}]," and the editor works normally for the session — but\nnothing survives a reload."]}],"\n"]}]
35:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/pdf-export","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"PDF export"}]]}],["$","$L5",null,{"href":"/docs/project-files","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Project files"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
36:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Autosave — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Your project saves itself in this browser — what persists, when, and the limits."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/autosave"}],["$","meta","6",{"property":"og:title","content":"Autosave — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Your project saves itself in this browser — what persists, when, and the limits."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/autosave"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Autosave — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Your project saves itself in this browser — what persists, when, and the limits."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L36","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
