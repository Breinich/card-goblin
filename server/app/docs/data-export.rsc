...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Data export"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Export one CSV row for every generated card, including computed virtual columns."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export Data"}]," in the status bar downloads a CSV print manifest. It contains one row\nfor every generated card instance—not merely one row for every spreadsheet row—so\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}]," combinations and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," copies appear separately and in the same order as\nthe preview and PDF."]}],"\n",["$","p","p-1",{"className":"my-4","children":"The first columns identify each instance:"}],"\n",["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"CSV column"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Meaning"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@card"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," declaration name"]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@sheet"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Bound ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet:"}]," name"]}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@row"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1-based source row number"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@card_number"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["1-based position inside that generated deck; the same value as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}]," / ","$L2e"]}]]}],"$L2f","$L30","$L31"]}]]}]}],"\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c"]}],"$L3d"]}]
2e:["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}]
2f:["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@project_card"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["1-based physical position across every generated deck; the same value as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]]}]]}]
30:["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@copy"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["1-based position among the current ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," copies"]}]]}]
31:["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@loop.<name>"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Selected enum case for each Card loop variable"}]]}]
32:["$","p","p-2",{"className":"my-4","children":["Those ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@"}]," names cannot collide with Goblin identifiers. The remaining columns are\nthe physical sheet cells followed by any virtual columns. Projects with several Card\nblocks or sheets use the union of their columns; cells that do not apply to an\ninstance are empty. CSV quoting follows the standard comma/newline/double-quote\nrules, and the file is UTF-8."]}]
33:["$","h2","h2-0",{"id":"virtual-columns","aria-label":"Virtual columns","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Virtual columns",["$","a",null,{"href":"#virtual-columns","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
34:["$","p","p-3",{"className":"my-4","children":"A virtual column is a formula declared inside a Sheet:"}]
35:["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Sheet: Monsters\n  column name: Text\n  column code: Text\n  column count: Number\n  virtual column card_code: Text = \"[card]|[code]\"\n"}]}]
36:["$","p","p-4",{"className":"my-4","children":["It is type-checked like other Goblin expressions and evaluates once for the exact\ngenerated card instance, so ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}]," can produce a different value for each copy.\nColumns, Card loop variables, all generation built-ins, and program ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," bindings are\nall available. For example, the formula can be shared through a global:"]}]
37:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"let card_code: \"[card]|[code]\"\n\nSheet: Monsters\n  column code: Text\n  virtual column card_code: Text = [card_code]\n"}]}]
38:["$","p","p-5",{"className":"my-4","children":"Virtual columns never appear in the spreadsheet, are never stored in row data, and\ncannot be edited. Change their expressions in the code editor. Their names must not\nduplicate a physical or another virtual column in the same Sheet."}]
39:["$","p","p-6",{"className":"my-4","children":["For a single Card block the download is named after that Card, such as\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Monster.csv"}],"; projects with several Card blocks download ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"cardgoblin-data.csv"}],"."]}]
3a:["$","h2","h2-1",{"id":"errors-and-the-current-preview","aria-label":"Errors and the current preview","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Errors and the current preview",["$","a",null,{"href":"#errors-and-the-current-preview","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3b:["$","p","p-7",{"className":"my-4","children":"CSV follows the current generated RenderModel. A row whose data fails produces the\nsame labelled error-placeholder instance in the model, so that instance still gets\na CSV row and its available identity/source values. PDF export deliberately skips\nerror-placeholder cards because there is no printable face to lay out."}]
3c:["$","p","p-8",{"className":"my-4","children":"While the code editor is broken, the preview holds the last good RenderModel. Export\nData uses that same last good result; it does not combine stale cards with the\ncurrently invalid source. If no Card block generates any instances, export is\ndisabled."}]
3d:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/roadmap","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Roadmap"}]]}],false]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3e:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Data export — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Export one CSV row for every generated card, including computed virtual columns."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/data-export"}],["$","meta","6",{"property":"og:title","content":"Data export — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Export one CSV row for every generated card, including computed virtual columns."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/data-export"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Data export — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Export one CSV row for every generated card, including computed virtual columns."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3e","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
