...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Images"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"The Image element — your own artwork from a URL or an uploaded asset, fit modes, and auto sizing."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Image: \"Portrait\"\n  x: 2\n  y: 4\n  width: 16\n  height: 12\n  src: \"https://example.com/art/[name].png\"\n  fit: cover\n  color: teal\n"}]}],"\n",["$","p","p-0",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," is a text ",["$","$L5","a-0",{"href":"/docs/expressions","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"expression"}],", so the URL can come straight from a\nsheet column (",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src: [art_url]"}],") or be built with interpolation, and different rows get\ndifferent art."]}],"\n",["$","h2","h2-0",{"id":"recolor-white-artwork","aria-label":"Recolor white artwork","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Recolor white artwork",["$","a",null,{"href":"#recolor-white-artwork","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-1",{"className":"my-4","children":["Add an optional ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," to multiply the artwork by a color:"]}],"\n",["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Image: \"Faction mark\"\n  x: 2\n  y: 2\n  width: 4\n  height: 4\n  src: \"asset:faction_mark\"\n  color: if [faction] == Faction.Sea then teal else crimson\n"}]}],"\n",["$","p","p-2",{"className":"my-4","children":["The default is ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"white"}],", which leaves every pixel unchanged. Multiplication is\nespecially useful for white PNG/SVG-style artwork: white pixels become the chosen\ncolor, black pixels stay black, and gray pixels keep their shading. Transparent and\npartly transparent edges keep their original alpha. This uses the same Color values\nas every other ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," — CSS names or six-digit ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#RRGGBB"}],", including expressions —\nand does not add ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rgba()"}]," or eight-digit hex."]}],"\n","$L2e","\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c"]}],"$L3d"]}]
2e:["$","p","p-3",{"className":"my-4","children":["Tinting happens only after the art loads. Loading and failed-image placeholders keep\ntheir normal gray/amber appearance. Both URL art and uploaded ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:"}]," art behave the\nsame way, and the exported PDF uses the exact same multiplied rendering as the\npreview."]}]
2f:["$","h2","h2-1",{"id":"the-box-and-the-art-are-two-different-shapes","aria-label":"The box and the art are two different shapes","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The box and the art are two different shapes",["$","a",null,{"href":"#the-box-and-the-art-are-two-different-shapes","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
30:["$","p","p-4",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width:"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height:"}]," declare a ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"box"}]," on the card — not the drawn size of the\nart. The art has its own proportions, and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit:"}]," says how the two are reconciled\nwhen they don't match:"]}]
31:["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit:"}]}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"What it does"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"contain"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["whole image visible, letterboxed inside the box — ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"the default"}]]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"cover"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"box fully covered, overflow cropped"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"stretch"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"image distorted to exactly fill the box"}]]}]]}]]}]}]
32:["$","blockquote","blockquote-0",{"className":"my-4 border-l-2 border-teal-700 bg-gray-800/40 py-1 pl-4 text-gray-400","children":["\n",["$","p","p-0",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Why didn't my image stretch?"}]," With the default ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit: contain"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height: 12"}],"\npromises a 12-unit box, ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"not"}]," 12 units of drawn art. The art keeps its own\nratio and letterboxes inside the box — a wide image draws shorter than 12,\ncentered, with empty space above and below. If you want the art deformed to fill\nthe box exactly, that's ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit: stretch"}],"; if you want the box itself to follow the\nart, give one dimension as ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}],"."]}],"\n"]}]
33:["$","h3","h3-0",{"id":"auto-size-the-box-from-the-art","aria-label":"auto — size the box from the art","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":[[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," — size the box from the art"],["$","a",null,{"href":"#auto-size-the-box-from-the-art","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
34:["$","p","p-5",{"className":"my-4","children":["Write ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," for exactly one of ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width:"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height:"}]," and that dimension follows the\nart: the other dimension × the image's own ratio. It's the way to say \"exactly as\ntall as the ratio demands\" — no letterboxing, no cropping, no distortion:"]}]
35:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Image: \"Banner\"\n  x: 0\n  y: 0\n  width: full\n  height: auto     # exactly as tall as the art's ratio makes it\n  src: [banner_url]\n"}]}]
36:["$","p","p-6",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width: full"}]," + ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height: auto"}]," is the idiom for full-bleed banner art at its\nnatural proportions. A few things to know:"]}]
37:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["Exactly ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"one"}]," of the pair can be ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," — both is an error, since nothing\nwould be left to derive the ratio from."]}],"\n",["$","li","li-1",{"children":["The ratio is only known once the image loads, so until then (and if the load\nfails) the box shows as a ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"square"}]," placeholder."]}],"\n",["$","li","li-2",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit:"}]," does nothing next to ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," — the box already matches the art's ratio,\nso all three modes draw the same picture. Writing it isn't an error; it's just\ninert."]}],"\n"]}]
38:["$","p","p-7",{"className":"my-4","children":["While an image downloads, its box shows a subtle gray placeholder; if the source fails\nto load, the box turns into an amber crossed-out placeholder instead. ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Neither is a\ncode or data error"}]," — the rest of the card renders normally, and fixing the source\nfixes the box. PDF export has one extra requirement for URL art — see\n",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}],"."]}]
39:["$","h2","h2-2",{"id":"art-with-no-hosting-uploaded-assets","aria-label":"Art with no hosting — uploaded assets","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Art with no hosting — uploaded assets",["$","a",null,{"href":"#art-with-no-hosting-uploaded-assets","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3a:["$","p","p-8",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," doesn't have to be a URL. Reference an image you've uploaded through the\n",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Assets"}]," drawer with the ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:"}]," scheme instead:"]}]
3b:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Image: \"Portrait\"\n  x: 2\n  y: 4\n  width: 16\n  height: 12\n  src: \"asset:dragon_art\"\n"}]}]
3c:["$","p","p-9",{"className":"my-4","children":["See ",["$","$L5","a-0",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Uploaded assets"}]," for the drawer itself, the 2 MB cap, and how\nuploads are stored — everything about ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," being a Text expression still\napplies, so ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src: [art]"}]," and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src: \"asset:[art]\""}]," work exactly like they do with a\nURL."]}]
3d:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/text","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Text & TextBox"}]]}],["$","$L5",null,{"href":"/docs/qr-codes","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"QR codes"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3e:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Images — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"The Image element — your own artwork from a URL or an uploaded asset, fit modes, and auto sizing."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/images"}],["$","meta","6",{"property":"og:title","content":"Images — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"The Image element — your own artwork from a URL or an uploaded asset, fit modes, and auto sizing."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/images"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Images — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"The Image element — your own artwork from a URL or an uploaded asset, fit modes, and auto sizing."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3e","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
