...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"PDF export"}],["$","span",null,{"title":"This is shipped but still moving — details may change.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-amber-800 bg-amber-950 text-amber-300 ","children":"Evolving"}]]}],["$","p",null,{"className":"text-gray-400","children":"Print options — page size, margins, cut lines, and duplex-mirrored backs."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export PDF"}]," sits in the preview toolbar. It prints what the preview shows, so if\nyour code is mid-break the export uses the same last-good render you're looking at."]}],"\n",["$","p","p-1",{"className":"my-4","children":"The button is disabled until there's at least one card to print."}],"\n",["$","h2","h2-0",{"id":"choosing-which-cards-to-print","aria-label":"Choosing which cards to print","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Choosing which cards to print",["$","a",null,{"href":"#choosing-which-cards-to-print","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-2",{"className":"my-4","children":["Every time you open ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export PDF"}],", ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Cards to print"}]," starts on ",["$","strong","strong-2",{"className":"font-semibold text-gray-100","children":"All"}],". Switch to\n",["$","strong","strong-3",{"className":"font-semibold text-gray-100","children":"Custom"}]," or choose ",["$","strong","strong-4",{"className":"font-semibold text-gray-100","children":"Choose cards…"}]," when you only need part of a large project.\nThis is a print-run choice only: it does not change your Goblin code, spreadsheet\nrows, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}],", saved project, or cloud copy."]}],"\n",["$","p","p-3",{"className":"my-4","children":["The chooser shows card thumbnails grouped by ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block. Use the Front/Back\ntoggle to identify either face, click individual checkboxes, or use ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Select all"}],"\nand ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Clear"}],". Cards with data errors stay visible at their original number but are\nunavailable because they have no printable face."]}],"\n",["$","p","p-4",{"className":"my-4","children":["For a quick known selection, type project-wide card numbers such as\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"1-6, 16, 18"}],". Commas and ascending inclusive ranges are accepted; spaces and\nduplicate numbers are harmless. ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Select only"}]," replaces the current selection and\n",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Deselect"}]," removes those numbers. A malformed, backwards, or out-of-range entry\nshows an error and changes nothing."]}],"\n","$L2e","\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41"]}],"$L42"]}]
2e:["$","p","p-5",{"className":"my-4","children":["These are generated-card numbers, not spreadsheet row numbers. Loops and ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}],"\ncan turn one row into several independently selectable cards. The numbers match the\neditor's project-wide card order and the ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"@project_card"}]," column in\n",["$","$L5","a-0",{"href":"/docs/data-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Export Data"}],". They never change when earlier cards are omitted."]}]
2f:["$","p","p-6",{"className":"my-4","children":"Selected cards keep their original order and pack together normally within their\nown deck; they do not leave blank holes. Decks still never share a page. The live\npage preview, matching backs, image checks, and export progress all update to the\nselected print run. Closing and reopening the export modal resets the choice to All."}]
30:["$","h2","h2-1",{"id":"the-preview","aria-label":"The preview","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The preview",["$","a",null,{"href":"#the-preview","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
31:["$","p","p-7",{"className":"my-4","children":["Next to the options is a picture of the actual page. It redraws as you change\nanything, so margins, spacing, cut lines and the mirrored back pages are all\nvisible ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"before"}]," you spend a render on a PDF. The arrows above it step through\nevery page the export will contain — with duplex backs, page 2 is page 1's mirrored\nback."]}]
32:["$","p","p-8",{"className":"my-4","children":"It's drawn from the same layout the exporter uses, with the same card artwork, so it\ncan't drift from the file you get. The one thing it can't show you is the 300 DPI\nrasterization: on paper the cards are images, here they're live vector art."}]
33:["$","h2","h2-2",{"id":"the-options","aria-label":"The options","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The options",["$","a",null,{"href":"#the-options","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
34:["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Option"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Default"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"What it does"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Page size"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Letter (215.9 × 279.4 mm)"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Or A4 (210 × 297 mm)."}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Backs"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Duplex"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"How back faces are laid out — see below."}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Outer margin (mm)"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"10"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Blank border on every page. Most home printers can't print to the edge. It's a minimum: the card grid is centred left-to-right (that centring is what keeps duplex backs aligned) and starts at the top margin, so the side margins are often a little wider than you asked for."}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Card spacing (mm)"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"0"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Gap between cards. ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"0"}]," means neighbours share a cut line — less cutting, no margin for error."]}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Cut lines"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Dotted"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Lines running edge to edge across the page at every card boundary. Also: off, red, bold."}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Cross marks"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Off"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Small crop crosses at card corners only. Also: dotted, red, bold."}]]}],["$","tr","tr-6",{"children":["$L43","$L44","$L45"]}]]}]]}]}]
35:["$","p","p-9",{"className":"my-4","children":["Guide styles are: ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"dotted"}]," (0.2 mm dotted black), ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"red"}]," (0.2 mm solid, easy to see\nagainst dark art), ",["$","strong","strong-2",{"className":"font-semibold text-gray-100","children":"bold"}]," (0.5 mm solid black)."]}]
36:["$","h2","h2-3",{"id":"backs","aria-label":"Backs","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Backs",["$","a",null,{"href":"#backs","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Duplex"}]," — after each page of fronts comes the matching page of backs, with columns\nmirrored. That's what makes a double-sided print line up when your printer flips on\nthe long edge."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Separate"}]," — all front pages first, then all back pages. For manual re-feeding."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"None"}]," — fronts only."]}],"\n"]}]
38:["$","p","p-10",{"className":"my-4","children":"Cut guides are drawn on back pages too, aligned to the mirrored grid."}]
39:["$","p","p-11",{"className":"my-4","children":["When ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Print page numbers"}]," is on, numbering counts physical card sheets rather than\nPDF pages. That is why matching sides say ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"1/10 front"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"1/10 back"}],": the label is\nmeant to keep those two pages paired after printing. The live page preview shows the\nsame label before export. The label is placed below the final occupied card row and\nis never pulled back over artwork. If the card grid reaches the bottom of the page,\nthe label can fall outside your printer's printable area or be clipped by the PDF\npage; increase the outer margin if you need the label to print."]}]
3a:["$","h2","h2-4",{"id":"how-it-lays-out","aria-label":"How it lays out","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["How it lays out",["$","a",null,{"href":"#how-it-lays-out","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3b:["$","p","p-12",{"className":"my-4","children":["Decks never share a page: each ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block starts fresh. Within a deck, as many cards\nas fit inside the margins are placed row by row."]}]
3c:["$","p","p-13",{"className":"my-4","children":"If a deck's cards can't fit even once inside the margins, the modal says so and blocks\nthe export — reduce the margin or spacing, or choose a larger page."}]
3d:["$","h2","h2-5",{"id":"quality-and-errors","aria-label":"Quality and errors","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Quality and errors",["$","a",null,{"href":"#quality-and-errors","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3e:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["Each ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"distinct"}]," card face is rendered once at ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"300 DPI"}]," through the browser's own\nrenderer, so fonts and icon ligatures come out exactly as they look in the preview,\nthen reused everywhere it appears. A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count: 10"}]," card doesn't cost ten renders."]}],"\n",["$","li","li-1",{"children":"While exporting, a progress bar advances through card-face rendering, image\nembedding, page construction, and final PDF saving. Large decks can still take a\nwhile, but the current stage and percentage remain visible."}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Error placeholder cards are skipped."}]," If any exist, the modal warns you how many\nbefore you export. They appear disabled in the card chooser. If ",["$","em","em-0",{"children":"every"}]," card is a\nplaceholder—or a Custom selection contains no printable cards—there's nothing to\nprint and export is blocked."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Images are checked before you export."}]," When the deck uses\n",["$","$L5","a-0",{"href":"/docs/images","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}]}]," shapes, the modal probes their URLs as it opens.\nEmbedding an image into the PDF needs the host's permission (the file is fetched\nwith ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"crossorigin=anonymous"}],", so the server must allow cross-origin use — CORS). Any\nimage that can't be embedded is warned about in the modal — \"N images could not be\nembedded\" — and prints as an amber crossed-out placeholder box. The export itself\nis never blocked by a broken image."]}],"\n",["$","li","li-4",{"children":["Copy counts are honoured — a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count: 2"}]," card prints twice."]}],"\n",["$","li","li-5",{"children":["The file downloads as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"<deckname>.pdf"}]," for a single-deck project, ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"cardgoblin.pdf"}],"\notherwise."]}],"\n"]}]
3f:["$","p","p-14",{"className":"my-4","children":"Your option choices are remembered until you reload the page."}]
40:["$","h2","h2-6",{"id":"not-yet","aria-label":"Not yet","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Not yet",["$","a",null,{"href":"#not-yet","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
41:["$","p","p-15",{"className":"my-4","children":["Bleed, safe zones, CMYK, and per-deck page settings aren't there yet — see the\n",["$","$L5","a-0",{"href":"/docs/roadmap","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"roadmap"}],". For a professional print run, check the printer's requirements\nbefore committing."]}]
42:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/diagnostics","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Diagnostics catalog"}]]}],["$","$L5",null,{"href":"/docs/autosave","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Autosave"}]]}]]}]
43:["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Print page numbers"}]}]
44:["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Off"}]
45:["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Adds plain text such as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"1/10 front"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"1/10 back"}]," immediately below the lowest card row. It never covers a card. A matching front/back pair shares its number, even in Separate mode."]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
46:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"PDF export — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Print options — page size, margins, cut lines, and duplex-mirrored backs."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/pdf-export"}],["$","meta","6",{"property":"og:title","content":"PDF export — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Print options — page size, margins, cut lines, and duplex-mirrored backs."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/pdf-export"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"PDF export — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Print options — page size, margins, cut lines, and duplex-mirrored backs."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L46","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
