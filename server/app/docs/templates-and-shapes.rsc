...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Templates & shapes"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Templates, the grid, the shape index, pivots, rotation, and Repeat — the drawing model shapes share."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Template:"}]," is a named drawing — a list of shapes rendered in the order you write\nthem, so ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"later shapes draw on top"}],"."]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Template: MonsterFront\n  Rectangle: \"Banner\"\n    x: 0\n    y: 0\n    width: full\n    height: 3\n    color: teal\n  Text: \"Title\"\n    x: middle\n    y: 0.7\n    size: 1.6\n    text: [name]\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":"A Template still gets sheet columns, Card loops, global lets, and generation built-ins\nfrom whichever Card reaches it. It can also declare typed parameters when a caller must\nchoose a layout or style explicitly."}],"\n",["$","h2","h2-0",{"id":"template-parameters","aria-label":"Template parameters","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Template parameters",["$","a",null,{"href":"#template-parameters","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-2",{"className":"my-4","children":["Declare required parameters directly inside the Template with\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"param name: Type"}],". The type may be ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Number"}],", ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Bool"}],", ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Color"}],", or an enum.\nDeclarations may appear anywhere among the Template's direct children and are hoisted\nacross its whole body. Parameters are immutable; they cannot be declared inside an\n",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If"}],", ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else"}],", or ",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],"."]}],"\n",["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":"$L2e"}],"\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41","\n","$L42","\n","$L43","\n","$L44","\n","$L45","\n","$L46","\n","$L47","\n","$L48","\n","$L49","\n","$L4a","\n","$L4b","\n","$L4c","\n","$L4d","\n","$L4e","\n","$L4f","\n","$L50","\n","$L51","\n","$L52","\n","$L53","\n","$L54","\n","$L55","\n","$L56","\n","$L57","\n","$L58","\n","$L59","\n","$L5a","\n","$L5b","\n","$L5c","\n","$L5d","\n","$L5e","\n","$L5f"]}],"$L60"]}]
2e:["$","code","code-0",{"className":"font-mono","children":"Enum: CardEdition\n  case Black\n  case White\n\nTemplate: MonsterFront\n  param edition: CardEdition\n\n  let background: if [edition] == CardEdition.Black\n    then #000000\n    else #FFFFFF\n\n  Rectangle:\n    x: 0\n    y: 0\n    width: full\n    height: full\n    color: [background]\n"}]
2f:["$","p","p-3",{"className":"my-4","children":["Supply arguments beneath ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front:"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Back:"}],". Each argument is an expression evaluated\nin the Card caller's scope:"]}]
30:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: BlackCards\n  # sheet, size, units, count...\n  Front: MonsterFront\n    edition: CardEdition.Black\n\nCard: WhiteCards\n  # same data and layout, different count/style choice\n  Front: MonsterFront\n    edition: CardEdition.White\n"}]}]
31:["$","p","p-4",{"className":"my-4","children":"Every declared parameter is required. Missing, extra, duplicate, or wrongly typed\narguments are compile errors."}]
32:["$","h2","h2-1",{"id":"reusing-templates","aria-label":"Reusing Templates","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Reusing Templates",["$","a",null,{"href":"#reusing-templates","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
33:["$","p","p-5",{"className":"my-4","children":"A Template can call another Template by writing its name as a node header:"}]
34:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Template: Frame\n  param edition: CardEdition\n  # draw the edition-specific frame...\n\nTemplate: MonsterFront\n  param edition: CardEdition\n\n  Frame:\n    edition: [edition]\n  If: [elite]\n    EliteBadge:\n"}]}]
35:["$","p","p-6",{"className":"my-4","children":["The called shapes are inserted at that exact position, so source order still controls\nwhich shapes draw on top. Calls may be nested and may sit inside ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else"}],", or\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],". Arguments use the same indented form as Card faces."]}]
36:["$","p","p-7",{"className":"my-4","children":["A called Template deliberately does not capture the caller's parameters, local ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}],"\nvalues, or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," index. Argument expressions ",["$","em","em-0",{"children":"do"}]," run in caller scope, so forwarding\nis explicit: ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"edition: [edition]"}]," above passes the outer parameter to ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Frame"}],". The\ncallee then sees its own parameters and locals plus global lets, Card loops, sheet\ncolumns, and generation built-ins. This keeps a Template's inputs readable at the call\nsite instead of making nested composition depend on hidden caller state."]}]
37:["$","p","p-8",{"className":"my-4","children":["For compatibility, a Template may still literally be named ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else"}]," and used\nas ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front: If"}]," or ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Back: Else"}],". Those two names cannot use nested-call shorthand,\nbecause ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}]," and ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}]," are structural there."]}]
38:["$","h2","h2-2",{"id":"drawing-conditionally","aria-label":"Drawing conditionally","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Drawing conditionally",["$","a",null,{"href":"#drawing-conditionally","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
39:["$","pre","pre-4",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"If: [equipment]\n  EquipmentFrontRotated:\nElse:\n  EquipmentFront:\n"}]}]
3a:["$","p","p-9",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}]," takes a one-line Bool expression. ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}]," is optional and must be the next\nnonblank, non-comment sibling at the same indentation. Both branches are checked; only the\nselected branch runs, so an unselected branch emits no shapes, reads no lets, and\nproduces no data errors. Branches have their own local scope. For else-if, nest an\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}]," inside ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}],"."]}]
3b:["$","h2","h2-3",{"id":"local-values","aria-label":"Local values","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Local values",["$","a",null,{"href":"#local-values","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3c:["$","p","p-10",{"className":"my-4","children":["Use ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let name: expression"}]," anywhere a Template node can appear, including inside\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else"}],", and ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],". A local let is immutable, visible throughout its lexical\nblock even before its declaration, and newly evaluated for each Template call,\nselected branch, or Repeat iteration. A callee cannot see it unless the caller passes\nit as an explicit argument."]}]
3d:["$","h2","h2-4",{"id":"the-coordinate-grid","aria-label":"The coordinate grid","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The coordinate grid",["$","a",null,{"href":"#the-coordinate-grid","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3e:["$","p","p-11",{"className":"my-4","children":"Cards use an abstract unit grid, so a layout survives a change of card size and still\nprints at exact millimetres."}]
3f:["$","pre","pre-5",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: Monster\n  size: poker      # 63.5 × 88.9 mm\n  x_units: 20      # → 1 unit = 63.5/20 = 3.175 mm\n  y_units: auto    # → 28 units tall, units stay square\n"}]}]
40:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}]}]," picks the physical card — see ",["$","$L5","a-0",{"href":"/docs/card-sizes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Card sizes"}],"."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x_units: N"}]}]," slices the card's ",["$","em","em-0",{"children":"width"}]," into N units. One unit = width ÷ N."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units: auto"}]}]," keeps units square and derives the vertical count. A poker card\nat 20 wide is exactly 28 tall. You ",["$","em","em-0",{"children":"can"}]," force an integer instead, which stretches\nunits out of square — you'll get a warning."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"full"}]}]," means the whole axis and ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"half"}]}]," means half of it, so ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width: full"}],"\nspans the card."]}],"\n"]}]
41:["$","p","p-12",{"className":"my-4","children":["Because units are square under ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}],", a shape that's 2 × 2 units is actually square\non paper. That's what ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width: full"}]," in the template above means: the banner spans the\ncard, whatever size the card turns out to be."]}]
42:["$","h2","h2-5",{"id":"the-shapes","aria-label":"The shapes","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The shapes",["$","a",null,{"href":"#the-shapes","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
43:["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Shape"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Required"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Optional (default)"}],["$","th","th-3",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Notes"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Rectangle"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y width height color"}]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," (top_left), ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]," (0)"]}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"a filled box"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y size text"}]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]," (black), ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font"}]," (geist), ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," (top_left), ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]," (0)"]}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["one line; ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size"}]," is text height in units — see ",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text & TextBox"}]]}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y width height text size"}]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$L61"," (black), ","$L62"," (geist), ","$L63"," (left), ","$L64"," (1.3), ","$L65"," (clip), ","$L66"," (top_left), ","$L67"," (0)"]}],"$L68"]}],"$L69","$L6a","$L6b","$L6c"]}]]}]}]
44:["$","h2","h2-6",{"id":"pivots-which-point-of-the-shape-xy-place","aria-label":"Pivots — which point of the shape x/y place","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[["Pivots — which point of the shape ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," place"],["$","a",null,{"href":"#pivots-which-point-of-the-shape-xy-place","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
45:["$","p","p-13",{"className":"my-4","children":["Every shape takes an optional ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot:"}]," naming ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"which point of the shape\nitself"}]," its ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," coordinates refer to — the shape's own handle, not a\npoint on the card. Nine points, spelled with underscores, vertical word\nfirst:"]}]
46:["$","div","table-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot:"}]}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["The point ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," place"]}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_left"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["top-left corner — ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"the default"}]]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_center"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"middle of the top edge"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_right"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"top-right corner"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"center_left"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"middle of the left edge"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"center_center"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"dead center"}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"center_right"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"middle of the right edge"}]]}],["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"bottom_left"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"bottom-left corner"}]]}],["$","tr","tr-7",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"bottom_center"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"middle of the bottom edge"}]]}],"$L6d"]}]]}]}]
47:["$","p","p-14",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"To center a shape on the card"}],", pair the halfway coordinate with the\nhalfway pivot — reach for this any time you want something centered:"]}]
48:["$","pre","pre-6",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"x: half\ny: half\npivot: center_center\n"}]}]
49:["$","p","p-15",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"half"}]," puts ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," at the card's own midpoint; ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot: center_center"}]," says\nthat midpoint is the shape's OWN center too — so the shape's center lands\nexactly on the card's center. (",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot: center_center"}]," with ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: 0, y: 0"}]," does\nsomething different, and it trips people up: it puts the shape's center on\nthe card's top-left CORNER — correct once you know ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," is always a point\non the card that the shape's own center gets placed at, but a common surprise\nif you expected it to pin a corner of the CARD instead.)"]}]
4a:["$","p","p-16",{"className":"my-4","children":["So ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot: bottom_right"}]," with ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: full"}]," and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y: full"}]," pins a shape to the\ncard's bottom-right corner."]}]
4b:["$","p","p-17",{"className":"my-4","children":"Spelling conveniences:"}]
4c:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Either word order works"}]," — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"center_bottom"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"bottom_center"}]," are the\nsame point."]}],"\n",["$","li","li-1",{"children":["Plain ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"center"}]," is shorthand for ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"center_center"}],"."]}],"\n",["$","li","li-2",{"children":["The original Text/Icon values ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"left"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"middle"}],", and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"right"}]," still work as\naliases for the top row (",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_left"}],", ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_center"}],", ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_right"}],"), so existing\ncards mean exactly what they always meant."]}],"\n"]}]
4d:["$","p","p-18",{"className":"my-4","children":"What the pivot moves, per shape:"}]
4e:["$","ul","ul-2",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["On ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Rectangle, Image, TextBox, and Qr"}]," the pivot moves the whole box:\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot: bottom_right"}]," means ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," are the box's bottom-right corner.\nInside a TextBox, ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"align:"}]," still lays each line within the box's width —\n",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"align"}]," places text ",["$","em","em-0",{"children":"in"}]," the box, ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," places the box ",["$","em","em-1",{"children":"on the card"}],"."]}],"\n",["$","li","li-1",{"children":["On ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Text and Icon"}]," the pivot applies to the drawn line itself:\nhorizontally it sets where the text starts, centers, or ends; vertically,\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," names the top, middle, or bottom of the text's height (",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}],"). The\ndefault ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_left"}]," is exactly the old behavior — ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," is the top of the line."]}],"\n",["$","li","li-2",{"children":["On an ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["Image with an ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," dimension"]}],", the pivot offsets the box the art\nactually resolves to. Until the image loads, the placeholder is a square, so\na pivoted ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," box can shift once the true ratio arrives — that's the\nsame load-time rule ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"auto"}]," itself follows."]}],"\n"]}]
4f:["$","p","p-19",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: middle"}]," is still shorthand for \"horizontally centered\" (Text and Icon only —\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y: middle"}]," is an error, and so is ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: middle"}]," on Rectangle, Image, TextBox, or Qr).\nIt always wins horizontally, and a written ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot:"}]," keeps its vertical say:\n",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: middle"}]," + ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot: bottom_left"}]," centers horizontally and pivots the\nbottom of the line."]}]
50:["$","h2","h2-7",{"id":"rotation-turning-a-shape-on-its-pivot","aria-label":"Rotation — turning a shape on its pivot","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Rotation — turning a shape on its pivot",["$","a",null,{"href":"#rotation-turning-a-shape-on-its-pivot","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
51:["$","p","p-20",{"className":"my-4","children":["Every shape also takes an optional ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate:"}]," — an angle in ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"degrees,\nclockwise"}],", and like any other number it can come from data or arithmetic.\nThe shape turns ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"around its pivot point"}],": ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y"}]," stay planted, and the\nshape swings around them. That's why the two properties pair so naturally —\nthe pivot names the shape's handle, and ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate:"}]," turns it on that handle."]}]
52:["$","p","p-21",{"className":"my-4","children":"To spin a shape in place, pivot it on its own center:"}]
53:["$","pre","pre-7",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Icon: \"Compass\"\n  x: half\n  y: half\n  size: 4\n  code: \"STARS\"\n  pivot: center_center\n  rotate: 45\n"}]}]
54:["$","p","p-22",{"className":"my-4","children":["With the default ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_left"}]," pivot, the shape swings around its top-left\ncorner instead — sometimes exactly what you want, often a surprise. If a\nrotation lands somewhere unexpected, check the pivot first."]}]
55:["$","p","p-23",{"className":"my-4","children":["Because the angle is ordinary arithmetic, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," makes fans and dials for\nfree — each copy at its own angle, all sharing one pivot point:"]}]
56:["$","pre","pre-8",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Repeat: 5 as i\n  Rectangle: \"Fan blade\"\n    x: half\n    y: full\n    width: 1\n    height: 6\n    color: teal\n    pivot: bottom_center\n    rotate: [i] * 15 - 30\n"}]}]
57:["$","p","p-24",{"className":"my-4","children":["Rotation changes how a shape is ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"painted, nothing more"}],": a rotated\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," still wraps against its unrotated width, and the\n",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"exported PDF"}]," shows exactly what the preview shows. Angles\noutside 0–360 work the obvious way — ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate: -90"}]," is a quarter-turn\ncounter-clockwise, the same as ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"270"}],"."]}]
58:["$","h2","h2-8",{"id":"repeat-numeric-repetition","aria-label":"Repeat — numeric repetition","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," — numeric repetition"],["$","a",null,{"href":"#repeat-numeric-repetition","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
59:["$","pre","pre-9",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Repeat: [health] as i\n  Icon:\n    x: 1.5 + [i] * 2\n    y: 25\n    size: 1.8\n    color: red\n    code: \"HEARTS\"\n"}]}]
5a:["$","p","p-25",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," draws its children N times, with ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[i]"}]," counting ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"0, 1, 2…"}],". There's no\nlayout engine — you position copies with arithmetic, which means rows, columns, grids,\nand arcs are all just math on ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[i]"}],"."]}]
5b:["$","ul","ul-3",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["The count can come from data (",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat: [health] as i"}],") or be computed."]}],"\n",["$","li","li-1",{"children":"Repeats nest freely — a grid is a repeat inside a repeat."}],"\n",["$","li","li-2",{"children":["The count expression must fit on ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"one line"}],"."]}],"\n",["$","li","li-3",{"children":["Cap: ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"500 Repeat/ForEach iterations per card"}],". Every iteration of either form\ncounts once against the same budget, including outer and inner iterations in\nnested repeats — it is not a count of the shapes eventually drawn. Crossing\nthe cap produces D004 and makes that affected card an error placeholder; it\ndoes not keep partially truncated artwork."]}],"\n"]}]
5c:["$","h2","h2-9",{"id":"foreach-collection-members","aria-label":"ForEach — collection members","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," — collection members"],["$","a",null,{"href":"#foreach-collection-members","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
5d:["$","p","p-26",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," draws its children once for every member of a ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}]," or ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}],".\nThe first binding is the enum value; the second is its zero-based position:"]}]
5e:["$","pre","pre-10",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"ForEach: [cost] as symbol, i\n  Image:\n    x: 2 + [i] * 3\n    y: 2\n    width: 2.5\n    height: 2.5\n    src: \"asset:mana_[symbol]\"\n"}]}]
5f:["$","p","p-27",{"className":"my-4","children":["Sets iterate in Enum declaration order. Lists preserve their cell order and repeat\nduplicate entries. Empty collections draw nothing. ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," nests with itself and\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],"; all iterations share the same 500-per-card safety budget. The header must\nfit on one line. As with Template calls from inside ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],", pass an item or index\nas an explicit Template argument when a called Template needs it."]}]
60:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/sheets-and-data","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Sheets & data"}]]}],["$","$L5",null,{"href":"/docs/text","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Text & TextBox"}]]}]]}]
61:["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]
62:["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font"}]
63:["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"align"}]
64:["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"line_height"}]
65:["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"overflow"}]
66:["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]
67:["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]
68:["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["wrapped multi-line text in a box — see ",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text & TextBox"}]]}]
69:["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y size code"}]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]," (black), ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," (top_left), ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"style"}]," (flat_dark), ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]," (0)"]}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["a game glyph — see ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Icons"}]]}]]}]
6a:["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y width height src"}]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit"}]," (contain), ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]," (white/unchanged), ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," (top_left), ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]," (0)"]}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["your own artwork with optional multiply tint — see ",["$","$L5","a-0",{"href":"/docs/images","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Images"}]]}]]}]
6b:["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Qr"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y size data"}]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]," (black), ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"background"}]," (white), ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"level"}]," (m), ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," (top_left), ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]," (0)"]}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["a scannable QR code — see ",["$","$L5","a-0",{"href":"/docs/qr-codes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"QR codes"}]]}]]}]
6c:["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat: N as i"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"—"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"—"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"draws its children N times — see below"}]]}]
6d:["$","tr","tr-8",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"bottom_right"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"bottom-right corner"}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
6e:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Templates & shapes — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Templates, the grid, the shape index, pivots, rotation, and Repeat — the drawing model shapes share."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/templates-and-shapes"}],["$","meta","6",{"property":"og:title","content":"Templates & shapes — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Templates, the grid, the shape index, pivots, rotation, and Repeat — the drawing model shapes share."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/templates-and-shapes"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Templates & shapes — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Templates, the grid, the shape index, pivots, rotation, and Repeat — the drawing model shapes share."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L6e","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
