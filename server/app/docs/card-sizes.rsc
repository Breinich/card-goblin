...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Card sizes"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"The built-in physical card presets — and custom millimetre sizes — in exact millimetres."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}]," on a ",["$","$L5","a-0",{"href":"/docs/cards-and-generation","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Card block"}]," picks the physical card. Sizes are\nexact millimetres, which is what makes PDF export print true to size."]}],"\n",["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}]}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Physical"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Inches"}],["$","th","th-3",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Good for"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"poker"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"63.5 × 88.9 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2.5 × 3.5 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"standard playing cards"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"bridge"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"57.15 × 88.9 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2.25 × 3.5 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"narrow hands, trick-takers"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"american"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"56 × 87 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2.2 × 3.43 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"board-game decks, the common sleeve size"}]]}],"$L2e","$L2f","$L30","$L31"]}]]}]}],"\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d"]}],"$L3e"]}]
2e:["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"tarot"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"70 × 120 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2.76 × 4.72 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"big art, oracle decks"}]]}]
2f:["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"square"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"70 × 70 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2.76 × 2.76 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"tiles, tokens"}]]}]
30:["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"mini"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"44 × 63.5 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1.73 × 2.5 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"resource cards, dense layouts"}]]}]
31:["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"domino"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"44.45 × 88.9 mm"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1.75 × 3.5 in"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"tall narrow cards, tarot-style minis"}]]}]
32:["$","p","p-1",{"className":"my-4","children":"The millimetres are the real definition; the inches are those values rounded, so\nthey're what to compare against a sleeve pack, not what to print from."}]
33:["$","h2","h2-0",{"id":"units-and-size","aria-label":"Units and size","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Units and size",["$","a",null,{"href":"#units-and-size","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
34:["$","p","p-2",{"className":"my-4","children":["The size preset and ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x_units:"}]," together fix the scale of everything you draw:"]}]
35:["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"size: poker\nx_units: 20      # 1 unit = 63.5 ÷ 20 = 3.175 mm\ny_units: auto    # 28 units tall — square units\n"}]}]
36:["$","p","p-3",{"className":"my-4","children":["With ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units: auto"}]," the units stay square and the vertical count follows from the\ncard's aspect ratio. It isn't always a whole number:"]}]
37:["$","div","table-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Size"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x_units: 20"}]," → height in units"]}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"poker"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"28 exactly"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"bridge"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"31.111…"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"american"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"31.071…"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"tarot"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"34.285…"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"square"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"20"}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"mini"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"28.863…"}]]}],["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"domino"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"40 exactly"}]]}]]}]]}]}]
38:["$","p","p-4",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"full"}]," on the vertical axis means that value, whatever it is — so ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height: full"}],"\nalways spans the card."]}]
39:["$","h2","h2-1",{"id":"custom-sizes","aria-label":"Custom sizes","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Custom sizes",["$","a",null,{"href":"#custom-sizes","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3a:["$","p","p-5",{"className":"my-4","children":["When no preset fits, give the card's exact dimensions ",["$","em","em-0",{"children":"instead of"}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}],":"]}]
3b:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: Token\n  sheet: Tokens\n  width_mm: 40\n  height_mm: 40\n  x_units: 10      # 1 unit = 40 ÷ 10 = 4 mm\n  y_units: auto\n  Front: TokenFront\n"}]}]
3c:["$","p","p-6",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width_mm:"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height_mm:"}]," are positive numbers in millimetres (decimals are\nfine — ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"poker"}]," itself is 63.5 wide), precise to two decimal places with a\n0.01 mm minimum, and they always travel as a pair: giving only one, or\ncombining either with ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}],", is an error."]}]
3d:["$","p","p-7",{"className":"my-4","children":["Everything else works exactly as with a preset — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x_units:"}]," divides the custom\nwidth, ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units: auto"}]," keeps units square, and ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}],"\nprints true to size. A card too large for the selected paper is reported when\nyou export."]}]
3e:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/errors","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Errors & diagnostics"}]]}],["$","$L5",null,{"href":"/docs/colors","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Colors"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3f:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Card sizes — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"The built-in physical card presets — and custom millimetre sizes — in exact millimetres."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/card-sizes"}],["$","meta","6",{"property":"og:title","content":"Card sizes — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"The built-in physical card presets — and custom millimetre sizes — in exact millimetres."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/card-sizes"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Card sizes — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"The built-in physical card presets — and custom millimetre sizes — in exact millimetres."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3f","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
