...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Cards & generation"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"The Card block, and the rows × loops × count math that builds a deck."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block is a card ",["$","em","em-0",{"children":"type"}],". It binds a sheet, a physical size, a coordinate\ngrid, and the templates that draw each face."]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: Monster\n  sheet: Monsters              # required — which data feeds it\n  size: poker                  # required — the physical card\n  x_units: 20                  # required — the coordinate grid width\n  y_units: auto                # required — auto keeps units square\n  loop: Suit as current_suit   # optional — multiplies the deck\n  count: [count]               # optional — copies per card (default 1)\n  Front: MonsterFront          # required\n    edition: CardEdition.Black # required when MonsterFront declares this param\n  Back: PlainBack              # optional — omitted means a plain white back\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"sheet:"}],", a physical size, ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x_units:"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units:"}],", and ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front:"}]," are required;\neverything else has a default.\nInstead of a ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}]," preset, a Card may declare an exact ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width_mm:"}]," +\n",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height_mm:"}]," pair — see ",["$","$L5","a-0",{"href":"/docs/card-sizes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"custom sizes"}],".\nIndented lines below ",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front:"}]," and ",["$","code","code-8",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Back:"}]," pass explicit arguments to that Template;\nsee ",["$","$L5","a-1",{"href":"/docs/templates-and-shapes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Template parameters"}],"."]}],"\n","$L2e","\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f"]}],"$L40"]}]
2e:["$","h2","h2-0",{"id":"how-many-cards-you-get","aria-label":"How many cards you get","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["How many cards you get",["$","a",null,{"href":"#how-many-cards-you-get","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
2f:["$","p","p-2",{"className":"my-4","children":"For each Card block:"}]
30:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"for each non-empty row of the bound sheet\n  for each combination of loop cases\n    emit `count` copies\n"}]}]
31:["$","p","p-3",{"className":"my-4","children":["Those copies are identical unless a face reads a per-instance generation binding such\nas ",["$","$L5","a-0",{"href":"/docs/sheets-and-data","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[copy]"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}],", or ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]]}],". Then each copy\nresolves on its own, since its number is genuinely different content."]}]
32:["$","p","p-4",{"className":"my-4","children":["So the deck is ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"rows × loop options × count"}],". With the demo's two rows, three suits,\nand counts of 2 and 1:"]}]
33:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["2 rows × 3 suits = ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"6 distinct faces"}]]}],"\n",["$","li","li-1",{"children":["2+2+2 + 1+1+1 = ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"9 physical cards"}]]}],"\n"]}]
34:["$","p","p-5",{"className":"my-4","children":["Multiple ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}]," lines nest in declaration order — rows × suits × elements × … Cases\ncome out in the order you declared them in the enum."]}]
35:["$","p","p-6",{"className":"my-4","children":["Every card generated this way can reference its row, copy, deck, deck-relative position,\nand project-wide position; see ",["$","$L5","a-0",{"href":"/docs/sheets-and-data","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"generation identity"}],"."]}]
36:["$","h2","h2-1",{"id":"count","aria-label":"count:","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}],["$","a",null,{"href":"#count","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","p","p-7",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," is an expression, so it can come from data (",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count: [count]"}],") or be computed\n(",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count: if [rare] then 1 else 3"}],"). It must evaluate to a whole number of at least 0 —\na ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"0"}]," simply produces no cards for that row."]}]
38:["$","p","p-8",{"className":"my-4","children":["All generation built-ins are legal in ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}],". Because copies do not exist yet, count\nuses the prospective first copy of that row × loop combination: ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[copy]"}]," is 1,\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}],"/",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}]," are the next deck position, and ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]," is the next\nproject position. A legal ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count: 0"}]," consumes no deck or project position."]}]
39:["$","h2","h2-2",{"id":"limits","aria-label":"Limits","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Limits",["$","a",null,{"href":"#limits","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3a:["$","p","p-9",{"className":"my-4","children":["A single Card block generates at most ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"2,000 physical cards"}],". A typo'd count of\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"999999"}]," triggers D007 and truncates that Card block with a note in the status bar\ninstead of freezing the editor."]}]
3b:["$","p","p-10",{"className":"my-4","children":["Separately, each card instance has a shared budget of ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["500 ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],"/",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}],"\niterations per card"]}],". Every iteration of either node counts, including outer and\ninner iterations of mixed nested loops. Crossing that budget is D004: the affected card becomes an error\nplaceholder rather than keeping a partially truncated face. Other cards continue to\ngenerate normally."]}]
3c:["$","h2","h2-3",{"id":"several-card-blocks","aria-label":"Several Card blocks","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Several Card blocks",["$","a",null,{"href":"#several-card-blocks","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3d:["$","p","p-11",{"className":"my-4","children":["A project can have as many ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," blocks as you like, and they can share sheets and\ntemplates. Each becomes its own group in the preview, and in\n",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}]," each deck starts on its own page — decks never share a\nsheet of paper."]}]
3e:["$","p","p-12",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}]," intentionally restarts for every Card block; ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}]," is its more explicit\nalias. Use ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]," only when you want one running ordinal across every block,\nand ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck]"}]," when the Card declaration name itself is meaningful."]}]
3f:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: Monster\n  sheet: Monsters\n  size: poker\n  ...\n\nCard: Token\n  sheet: Tokens\n  size: square\n  ...\n"}]}]
40:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/expressions","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Expressions"}]]}],["$","$L5",null,{"href":"/docs/errors","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Errors & diagnostics"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
41:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Cards & generation — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"The Card block, and the rows × loops × count math that builds a deck."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/cards-and-generation"}],["$","meta","6",{"property":"og:title","content":"Cards & generation — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"The Card block, and the rows × loops × count math that builds a deck."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/cards-and-generation"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Cards & generation — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"The Card block, and the rows × loops × count math that builds a deck."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L41","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
