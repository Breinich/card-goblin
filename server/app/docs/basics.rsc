...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Basics & syntax"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Indentation, comments, names, labels — the shape of every Goblin file."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Goblin script is an outline language: what's indented under something belongs to it.\nThere are four kinds of named top-level block — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Enum"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Template"}],", and\n",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card"}]," — plus global ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," values. They can appear in any order (forward references\nwork)."]}],"\n",["$","h2","h2-0",{"id":"indentation-is-structure","aria-label":"Indentation is structure","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Indentation is structure",["$","a",null,{"href":"#indentation-is-structure","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Template: MonsterFront\n  Rectangle: \"Banner\"\n    x: 0\n    color: teal\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":["The ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Rectangle"}]," belongs to the template; ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x"}]," and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]," belong to the rectangle. Use\nspaces or tabs, but be consistent within a file."]}],"\n",["$","h2","h2-1",{"id":"comments","aria-label":"Comments","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Comments",["$","a",null,{"href":"#comments","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-2",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#"}]," starts a comment that runs to the end of the line."]}],"\n",["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"# the monster deck — suits come from the loop\nEnum: Suit\n  case Rock     # beats scissors\n"}]}],"\n","$L2e","\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e"]}],"$L3f"]}]
2e:["$","p","p-3",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"One quirk:"}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#"}]," followed by exactly six hex digits is a ",["$","em","em-0",{"children":"color"}],", not a comment\n(",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#ff0000"}],"). Don't start a comment with something like ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"#ff0000"}],"."]}]
2f:["$","h2","h2-2",{"id":"names","aria-label":"Names","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Names",["$","a",null,{"href":"#names","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
30:["$","p","p-4",{"className":"my-4","children":["Declared names — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Suit"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Monsters"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"MonsterFront"}]," — are plain words: a letter,\nthen letters, digits, or underscores. No quotes."]}]
31:["$","p","p-5",{"className":"my-4","children":["A small set of words is reserved and can't be used as names: the block openers\n(",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Enum"}]," ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet"}]," ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Template"}]," ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card"}]," ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Rectangle"}]," ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," ",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]," ",["$","code","code-8",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}],"\n",["$","code","code-9",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Qr"}]," ",["$","code","code-10",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," ",["$","code","code-11",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front"}]," ",["$","code","code-12",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Back"}],"), the declaration words (",["$","code","code-13",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"case"}]," ",["$","code","code-14",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column"}],"), and the\nexpression words (",["$","code","code-15",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"if"}]," ",["$","code","code-16",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"then"}]," ",["$","code","code-17",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"else"}]," ",["$","code","code-18",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"and"}]," ",["$","code","code-19",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"or"}]," ",["$","code","code-20",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"not"}]," ",["$","code","code-21",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"as"}],")."]}]
32:["$","p","p-6",{"className":"my-4","children":["Everything else is fair game. Property words like ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}],", and ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"full"}],"\nare ordinary identifiers — so ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column count: Number"}]," is perfectly legal, and ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[count]"}],"\nreads that column. Meaning comes from position, and ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[brackets]"}]," always mean a data\nreference."]}]
33:["$","p","p-7",{"className":"my-4","children":["Several newer forms are contextual, not reserved names: ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," is special only in\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let name: value"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"param"}]," only in ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"param name: Type"}]," directly inside a Template,\n",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"virtual"}]," only in ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"virtual column name: Type = expression"}]," inside a Sheet, and\ncapitalized ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}],"/",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else:"}]," and ",["$","code","code-8",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach:"}]," only where a Template node can appear.\n",["$","code","code-9",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}],"/",["$","code","code-10",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}]," are special only in type positions, and ",["$","code","code-11",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"contains(...)"}],"\nonly in expression position. ",["$","code","code-12",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column let: Text"}],",\n",["$","code","code-13",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column param: Text"}],", ",["$","code","code-14",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column virtual: Text"}],", ",["$","code","code-15",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Template: If"}],", and ",["$","code","code-16",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front: If"}]," are\ntherefore still legal."]}]
34:["$","h2","h2-3",{"id":"labels","aria-label":"Labels","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Labels",["$","a",null,{"href":"#labels","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","p","p-8",{"className":"my-4","children":["The quoted string after a shape is an optional ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"label"}],", purely for your own\nreadability. It's never referenced by anything:"]}]
36:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Rectangle: \"Banner\"      # labelled\nRectangle:               # unlabelled — identical behaviour\n"}]}]
37:["$","h2","h2-4",{"id":"values-can-span-lines","aria-label":"Values can span lines","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Values can span lines",["$","a",null,{"href":"#values-can-span-lines","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
38:["$","p","p-9",{"className":"my-4","children":"A property's value may continue onto following lines as long as they're indented\ndeeper than the property name:"}]
39:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"color: if [current_suit] == Suit.Rock then grey\n       else if [current_suit] == Suit.Paper then gold\n       else mediumpurple\n"}]}]
3a:["$","p","p-10",{"className":"my-4","children":["This works for property lines (including explicit Template call arguments) and\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let name:"}]," initializers. Block headers like\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat:"}]," and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If:"}]," never continue — their indented lines are children, so their\nexpressions have to fit on one line."]}]
3b:["$","h2","h2-5",{"id":"data-references","aria-label":"Data references","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Data references",["$","a",null,{"href":"#data-references","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3c:["$","p","p-11",{"className":"my-4","children":["Square brackets always mean ",["$","em","em-0",{"children":"look this value up"}],":"]}]
3d:["$","pre","pre-4",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"text: [name]\nx: 1.5 + [i] * 2\ntext: \"Cost: [cost]\"     # interpolated inside a string\ntext: \"Card [card:03]\"   # Number zero-padded to a minimum width of 3\n"}]}]
3e:["$","p","p-12",{"className":"my-4","children":["Where those values come from is ",["$","$L5","a-0",{"href":"/docs/sheets-and-data","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Sheets and data"}],", including the\nNumber-only ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name:0N]"}]," interpolation format. To write a literal ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"["}]," inside a string,\ndouble it: ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[["}],"."]}]
3f:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/the-editor","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"The editor"}]]}],["$","$L5",null,{"href":"/docs/sheets-and-data","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Sheets & data"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
40:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Basics & syntax — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Indentation, comments, names, labels — the shape of every Goblin file."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/basics"}],["$","meta","6",{"property":"og:title","content":"Basics & syntax — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Indentation, comments, names, labels — the shape of every Goblin file."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/basics"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Basics & syntax — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Indentation, comments, names, labels — the shape of every Goblin file."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L40","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
