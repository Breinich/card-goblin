...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Quickstart"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"The five-minute tour — a sample project, block by block."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Opening the editor first asks you to choose or import a project. This page uses the\noriginal Monster sample as a compact tour of the Goblin language; it is documentation,\nnot an automatically loaded starter. Open ",["$","$L5","a-0",{"href":"/editor","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"the editor"}]," alongside, choose a\nproject, and adapt the examples as you read — everything recompiles about a third of\na second after you stop typing."]}],"\n",["$","h2","h2-0",{"id":"1-an-enum-a-fixed-set-of-options","aria-label":"1. An Enum — a fixed set of options","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["1. An Enum — a fixed set of options",["$","a",null,{"href":"#1-an-enum-a-fixed-set-of-options","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Enum: Suit\n  case Rock\n  case Paper\n  case Scissors\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":["Enums do two jobs: they can ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"type a spreadsheet column"}]," (its cells become\ndropdowns), and they can ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"drive card generation"}]," via ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}]," — one card per case."]}],"\n",["$","h2","h2-1",{"id":"2-a-sheet-the-spreadsheets-columns","aria-label":"2. A Sheet — the spreadsheet's columns","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["2. A Sheet — the spreadsheet's columns",["$","a",null,{"href":"#2-a-sheet-the-spreadsheets-columns","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Sheet: Monsters\n  column name: Text\n  column cost: Number\n  column health: Number\n  column count: Number\n"}]}],"\n",["$","p","p-2",{"className":"my-4","children":["A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet"}]," declares a tab in the spreadsheet panel and the columns on it. Column types\nare ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Number"}],", any Enum you declared, or a multi-enum ","$L2e","/","$L2f",".\n","$L30"," Add a column here and it appears in the grid; rename one and the data\nfollows it."]}],"\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41"]}],"$L42"]}]
2e:["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}]
2f:["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}]
30:["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"The code owns the columns; you own\nthe rows."}]
31:["$","p","p-3",{"className":"my-4","children":["More in ",["$","$L5","a-0",{"href":"/docs/sheets-and-data","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Sheets and data"}],"."]}]
32:["$","h2","h2-2",{"id":"3-a-template-what-a-card-looks-like","aria-label":"3. A Template — what a card looks like","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["3. A Template — what a card looks like",["$","a",null,{"href":"#3-a-template-what-a-card-looks-like","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
33:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Template: MonsterFront\n  Rectangle: \"Banner\"\n    x: 0\n    y: 0\n    width: full\n    height: 3\n    color: if [current_suit] == Suit.Rock then grey\n           else if [current_suit] == Suit.Paper then gold\n           else mediumpurple\n  Text: \"Title\"\n    x: middle\n    y: 0.7\n    size: 1.6\n    color: black\n    text: [name]\n  Repeat: [health] as i\n    Icon:\n      x: 1.5 + [i] * 2\n      y: 25\n      size: 1.8\n      color: red\n      code: \"HEARTS\"\n"}]}]
34:["$","p","p-4",{"className":"my-4","children":"A template is a drawing: shapes listed top to bottom, later ones drawn on top."}]
35:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name]"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[health]"}]," pull from the spreadsheet row of whichever card is being\ndrawn."]}],"\n",["$","li","li-1",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[current_suit]"}]," comes from the Card's ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}]," (below)."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat:"}]," is the one to notice."]}]," It draws its children N times — here, one heart\nper point of health, each placed by index math (",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[i]"}]," counts 0, 1, 2…). One number\nin a cell becomes a row of hearts."]}],"\n"]}]
36:["$","p","p-5",{"className":"my-4","children":"The demo's full template also has a cost label and a suit icon. A back is just another\ntemplate:"}]
37:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Template: PlainBack\n  Rectangle:\n    x: 0\n    y: 0\n    width: full\n    height: full\n    color: teal\n"}]}]
38:["$","p","p-6",{"className":"my-4","children":["More in ",["$","$L5","a-0",{"href":"/docs/templates-and-shapes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Templates and shapes"}],"."]}]
39:["$","h2","h2-3",{"id":"4-a-card-tie-it-together","aria-label":"4. A Card — tie it together","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["4. A Card — tie it together",["$","a",null,{"href":"#4-a-card-tie-it-together","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3a:["$","pre","pre-4",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: Monster\n  sheet: Monsters\n  size: poker\n  x_units: 20\n  y_units: auto\n  loop: Suit as current_suit\n  count: [count]\n  Front: MonsterFront\n  Back: PlainBack\n"}]}]
3b:["$","p","p-7",{"className":"my-4","children":["A ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card"}]," block says which sheet feeds it, the physical size, the coordinate grid, and\nwhich templates draw the front and back."]}]
3c:["$","p","p-8",{"className":"my-4","children":["Cards are generated as ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"rows × loop options × count"}],". With 2 rows, 3 suits, and\ncounts of 2 and 1, you get 2 × 3 = 6 distinct faces and 9 physical cards. Omit ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}],"\nfor one card per row; omit ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Back:"}]," for a plain white back."]}]
3d:["$","p","p-9",{"className":"my-4","children":["More in ",["$","$L5","a-0",{"href":"/docs/cards-and-generation","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Cards and generation"}],"."]}]
3e:["$","h2","h2-4",{"id":"5-try-changing-things","aria-label":"5. Try changing things","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["5. Try changing things",["$","a",null,{"href":"#5-try-changing-things","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3f:["$","p","p-10",{"className":"my-4","children":"Each of these exercises a different part of the pipeline:"}]
40:["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Change"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"What should happen"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Set Dragon's ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"health"}]," to 7"]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Every Dragon card grows to 7 hearts"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Set a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"cost"}]," cell to ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"abc"}]]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"That cell flags red; only that row's cards become placeholders"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Delete the ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"else mediumpurple"}]," line"]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"A squiggle appears; the preview freezes on the last good render"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Change ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"then gold"}]," to ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"then hotpink"}]]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Paper banners recolor"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Set Dragon's ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count"}]," to 5"]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"The deck grows from 9 to 18 cards"}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Change ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\"SWORDS\""}]," to ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\"D6\""}]]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"The icon swaps glyph"}]]}]]}]]}]}]
41:["$","p","p-11",{"className":"my-4","children":["Then hit ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export PDF"}]," in the preview toolbar to get it on paper —\nsee ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}],"."]}]
42:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/what-is-cardgoblin","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"What is CardGoblin"}]]}],["$","$L5",null,{"href":"/docs/the-editor","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"The editor"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
43:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Quickstart — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"The five-minute tour — a sample project, block by block."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/quickstart"}],["$","meta","6",{"property":"og:title","content":"Quickstart — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"The five-minute tour — a sample project, block by block."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/quickstart"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Quickstart — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"The five-minute tour — a sample project, block by block."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L43","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
