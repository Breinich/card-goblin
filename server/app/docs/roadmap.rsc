...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Roadmap"}],["$","span",null,{"title":"This is shipped but still moving — details may change.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-amber-800 bg-amber-950 text-amber-300 ","children":"Evolving"}]]}],["$","p",null,{"className":"text-gray-400","children":"What's shipped, what's being built, and what's still an open question."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":"CardGoblin is a living project. This page says where it actually is — expect it to\nchange."}],"\n",["$","h2","h2-0",{"id":"shipped","aria-label":"Shipped","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Shipped",["$","a",null,{"href":"#shipped","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-1",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"The editor and the language."}]," Code, live SVG preview, and a schema-driven\nspreadsheet, wired together with a ~300 ms live compile. Enums, sheets, templates,\nshapes, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}]," data with ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"contains"}]," and ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}],", the full\nexpression engine, and per-card error isolation — the whole\npipeline from script to rendered deck."]}],"\n",["$","p","p-2",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"PDF export."}]," Page size, margins, spacing, cut lines, crop marks, and\nduplex-mirrored backs, rendered at 300 DPI. See ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}],"."]}],"\n",["$","p","p-3",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Autosave."}]," Your project — code and rows — survives a reload in your browser;\n",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"New / Open Project"}]," returns to the project chooser. See ",["$","$L5","a-0",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Autosave"}],"."]}],"\n",["$","p","p-4",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Autocomplete."}]," The code editor suggests what fits where your cursor is — column\nnames, property names, enum cases, color names, icon codes. See\n",["$","$L5","a-0",{"href":"/docs/the-editor","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"The editor"}],"."]}],"\n",["$","p","p-5",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Custom card sizes."}]," ","$L2e"," + ","$L2f"," on a Card, beyond the\n","$L30","."]}],"\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41","\n","$L42"]}],"$L43"]}]
2e:["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width_mm:"}]
2f:["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height_mm:"}]
30:["$","$L5","a-0",{"href":"/docs/card-sizes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"built-in presets"}]
31:["$","p","p-6",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Icon styles."}]," All ten Dicier faces (flat/block/round × dark/light/heavy,\nplus pixel) via ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"style:"}]," — see ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Icons"}],"."]}]
32:["$","p","p-7",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["The ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}]," element."]}]," Your own artwork on a card, from a URL — with ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"fit:"}],"\ncontrol and PDF embedding. See ",["$","$L5","a-0",{"href":"/docs/images","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Images"}],"."]}]
33:["$","p","p-8",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Uploaded assets."}]," An Assets drawer for images local to your machine — upload,\nrename, delete, and reference them with ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:<name>"}]," in any ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}],", no hosting\nrequired. Bundled into ",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project files"}]," so art travels with the\nproject. See ",["$","$L5","a-1",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Uploaded assets"}],"."]}]
34:["$","p","p-9",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Project files."}]," Export the project as a file and import it back — backup,\nmoving between browsers, and keeping more than one project. See\n",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Project files"}],"."]}]
35:["$","p","p-10",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Template composition and parameters."}]," Templates can declare typed ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"param"}],"\ninputs and call other Templates in source order, including inside ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"If"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Else"}],",\n",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],", and ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}],". Arguments are explicit, so nested layouts stay reusable without hidden\ncaller state. See ",["$","$L5","a-0",{"href":"/docs/templates-and-shapes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Templates & shapes"}],"."]}]
36:["$","p","p-11",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Text wrapping."}]," The ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," element: multi-line text that wraps in the\ncompiler itself, so the preview and the PDF always agree — with hard breaks\n(",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\\n"}]," and newlines in cells), alignment, and clip/shrink overflow control. See\n",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text & TextBox"}],"."]}]
37:["$","p","p-12",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Fonts."}]," Nine bundled faces on ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," — Geist (the default)\nplus eight more from Cormorant Garamond and Courier Prime — via ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}],", with\nwrapping measured against each font's own letterforms. See\n",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text & TextBox"}],"."]}]
38:["$","p","p-13",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"QR codes."}]," The ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Qr"}]," element: scannable codes generated straight from sheet\ndata, with error-correction levels and a scan-safe quiet zone — the idiom for\ngiving every card in a deck its own code on the back. See\n",["$","$L5","a-0",{"href":"/docs/qr-codes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"QR codes"}],"."]}]
39:["$","p","p-14",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Inline icons."}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{HEARTS}"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{asset:skull}"}]," markers draw Dicier glyphs and\nuploaded art right inside ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," text — including markers that\narrive from cell data — each in a one-em slot that wraps like a word. See\n",["$","$L5","a-0",{"href":"/docs/text#inline-icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Inline icons"}],"."]}]
3a:["$","p","p-15",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Reusable resolved text."}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}]," expands a top-level Text-valued\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let name:"}]," once before inline icon, asset, and color markers are parsed — also\nwhen the alias marker comes from cell data. A cell such as\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Deal 2 {alias:damage_icon}."}]," can insert one shared, tinted swords asset. See\n",["$","$L5","a-0",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text aliases"}],"."]}]
3b:["$","p","p-16",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Additive color styling."}]," Image ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," multiply-tints artwork (white is the\nunchanged default), while nested ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{color:red}…{/color}"}]," scopes recolor words,\nDicier glyphs, and inline asset art without changing TextBox wrapping. See\n",["$","$L5","a-0",{"href":"/docs/images#recolor-white-artwork","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Images"}]," and\n",["$","$L5","a-1",{"href":"/docs/text#scoped-colors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Scoped colors"}],"."]}]
3c:["$","h2","h2-1",{"id":"further-out","aria-label":"Further out","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Further out",["$","a",null,{"href":"#further-out","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3d:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Sharing by link"}]," — a read-only view of a deck anyone can open. The security,\nhosting cost, expiry, and deletion model still need design before this is a\npromise."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Uploaded fonts"}]," — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}]," currently picks from a small bundled set (see\n",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text & TextBox"}],"); bringing your OWN font file, the way uploaded\nassets already work for images, is a separate, later piece."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Rich text in boxes"}]," — inline icons and scoped colors shipped (see\n",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Text & TextBox"}],"); ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"bold and italic runs"}]," are\nthe remaining piece, still a later design round."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"A browsable icon picker"}]," — search and preview the ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"888 Dicier\ncodes"}]," visually instead of typing them from memory."]}],"\n"]}]
3e:["$","h2","h2-2",{"id":"open-questions","aria-label":"Open questions","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Open questions",["$","a",null,{"href":"#open-questions","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3f:["$","p","p-17",{"className":"my-4","children":"Things that are genuinely undecided, not just unbuilt:"}]
40:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Auto-layout containers"}]," (",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Row"}],", ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Stack"}],") as sugar over ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," — worth the\nlanguage surface, or is index math enough?"]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Inline face templates"}]," — anonymous Template bodies directly beneath ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Front:"}],"\nor ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Back:"}],"; named Template composition is already shipped."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Print fidelity"}]," — bleed, safe zones, and what \"print-ready\" should mean for a\nprofessional run rather than a home printer."]}],"\n"]}]
41:["$","h2","h2-3",{"id":"following-along","aria-label":"Following along","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Following along",["$","a",null,{"href":"#following-along","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
42:["$","p","p-18",{"className":"my-4","children":["The design document — including every decision made so far and why — lives in the\nrepository at ",["$","a","a-0",{"href":"https://github.com/eduAguilar96/card-goblin/blob/main/docs/DESIGN.md","target":"_blank","rel":"noreferrer noopener","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"docs/DESIGN.md"}]}],". If you want to build on\nCardGoblin, ",["$","a","a-1",{"href":"https://github.com/eduAguilar96/card-goblin/blob/main/docs/development.md","target":"_blank","rel":"noreferrer noopener","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"docs/development.md"}]}]," is the developer guide."]}]
43:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/limits","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Current limits"}]]}],["$","$L5",null,{"href":"/docs/data-export","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Data export"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
44:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Roadmap — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"What's shipped, what's being built, and what's still an open question."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/roadmap"}],["$","meta","6",{"property":"og:title","content":"Roadmap — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"What's shipped, what's being built, and what's still an open question."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/roadmap"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Roadmap — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"What's shipped, what's being built, and what's still an open question."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L44","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
