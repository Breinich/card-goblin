...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Uploaded assets"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Bring your own art with no hosting — the Assets drawer, the 2 MB cap, and how uploads are stored."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," on an ",["$","$L5","a-0",{"href":"/docs/images","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}]}]," doesn't have to be a URL. The\n",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Assets"}]," drawer holds pictures uploaded straight from your machine, so your own\nart can go on a card with nothing to host and no link to keep alive."]}],"\n",["$","h2","h2-0",{"id":"the-drawer","aria-label":"The drawer","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The drawer",["$","a",null,{"href":"#the-drawer","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-1",{"className":"my-4","children":["The ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Assets"}]," button in the status bar (with a count badge once you've uploaded\nsomething) opens a drawer where you upload images — drag and drop, or the file\npicker. Each upload gets a name, derived from the filename and renameable anytime,\nplus a thumbnail and a ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Copy ref"}]," button that copies ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:<name>"}],", ready to\npaste into a ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," line."]}],"\n",["$","h2","h2-1",{"id":"referencing-an-upload","aria-label":"Referencing an upload","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Referencing an upload",["$","a",null,{"href":"#referencing-an-upload","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-2",{"className":"my-4","children":["Reference an upload with the ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:"}]," scheme instead of a URL:"]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Image: \"Portrait\"\n  x: 2\n  y: 4\n  width: 16\n  height: 12\n  src: \"asset:dragon_art\"\n"}]}],"\n",["$","p","p-3",{"className":"my-4","children":["Everything about ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," being a Text expression still applies — an asset reference\nworks from a sheet column (","$L2e",") or built with interpolation\n(","$L2f","), so different rows can point at different uploads exactly\nlike different URLs."]}],"\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a"]}],"$L3b"]}]
2e:["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src: [art]"}]
2f:["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src: \"asset:[art]\""}]
30:["$","p","p-4",{"className":"my-4","children":["Uploads also work ",["$","em","em-0",{"children":"inside text"}],": ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{asset:dragon_art}"}]," in any ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," or ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],"\n",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text:"}]," draws the upload as an inline icon in a one-em slot — see\n",["$","$L5","a-0",{"href":"/docs/text#inline-icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Inline icons"}],"."]}]
31:["$","p","p-5",{"className":"my-4","children":["If the same colored asset fragment belongs at different positions inside many\nspreadsheet descriptions, wrap it in a top-level Text let and place it with\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}],". The ",["$","$L5","a-0",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"resolved-text alias example"}],"\nuses ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{color:#cc2222}{asset:swords}{/color}"}]," so each cell can say, for example,\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Deal 2 {alias:damage_icon}."}]," without duplicating the asset/color markup."]}]
32:["$","h2","h2-2",{"id":"the-2-mb-cap","aria-label":"The 2 MB cap","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The 2 MB cap",["$","a",null,{"href":"#the-2-mb-cap","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
33:["$","p","p-6",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"2 MB"}]," per image — enough for card-sized art at print resolution, not a place\nfor full-resolution photography. The drawer says so if a file is over the limit."]}]
34:["$","h2","h2-3",{"id":"renaming-only-updates-the-library","aria-label":"Renaming only updates the library","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Renaming only updates the library",["$","a",null,{"href":"#renaming-only-updates-the-library","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","p","p-7",{"className":"my-4","children":["Renaming doesn't rewrite ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," lines for you — rename ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"dragon_art"}]," to ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"dragon"}],"\nand every ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src: \"asset:dragon_art\""}]," still says the old name, now pointing at\nnothing. Update those references yourself; the compiler's unknown-asset warning\nsquiggles exactly the ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," lines that need it, so you won't miss one.\nReferencing a name that doesn't exist yet (or anymore) isn't an error, just that\nwarning — you might be about to upload it."]}]
36:["$","h2","h2-4",{"id":"where-uploads-are-stored","aria-label":"Where uploads are stored","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Where uploads are stored",["$","a",null,{"href":"#where-uploads-are-stored","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","p","p-8",{"className":"my-4","children":["Uploads live in this browser's IndexedDB, separately from the code-and-rows\n",["$","$L5","a-0",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"autosave"}],": they save ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"the moment you upload them"}],", not on\nautosave's one-second debounce, and they survive a reload the same way the rest of\nyour project does. Opening or importing another project switches its uploads\ntogether with its code and rows — separate stores under the hood, activated as one\nproject."]}]
38:["$","p","p-9",{"className":"my-4","children":["Uploaded assets always embed in an ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"exported PDF"}]," — unlike URL art,\nthey never depend on a host allowing cross-origin use, since the file never leaves\nyour browser."]}]
39:["$","p","p-10",{"className":"my-4","children":[["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Exporting a project file"}]," bundles your uploads into the file\nitself — the art, not just a reference to it — so handing someone a\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":".cardgoblin.json"}]," hands them the art too. A file exported before uploaded assets\nexisted has no art in it, so the newly imported project starts with no uploads."]}]
3a:["$","p","p-11",{"className":"my-4","children":["Each immutable project ID has its own browser library. Anonymous projects stay\non this device; an exported ",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project file"}]," is the supported\nway to move one. Signed-in administrator cloud projects upload reviewed formats\nunder content-addressed keys and restore them with the project on another device."]}]
3b:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/project-files","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Project files"}]]}],["$","$L5",null,{"href":"/docs/limits","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Current limits"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3c:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Uploaded assets — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Bring your own art with no hosting — the Assets drawer, the 2 MB cap, and how uploads are stored."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/assets"}],["$","meta","6",{"property":"og:title","content":"Uploaded assets — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Bring your own art with no hosting — the Assets drawer, the 2 MB cap, and how uploads are stored."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/assets"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Uploaded assets — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Bring your own art with no hosting — the Assets drawer, the 2 MB cap, and how uploads are stored."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3c","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
