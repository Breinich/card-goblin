...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Errors & diagnostics"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"What each kind of error looks like, and why one mistake never blanks a deck."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["CardGoblin's rule is: ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"one mistake never blanks your deck."}]]}],"\n",["$","p","p-1",{"className":"my-4","children":"Every error is reported in the panel where you can act on it, and the blast radius is\nkept as small as the mistake."}],"\n",["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"You see"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"It means"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Red squiggle in the code"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"A code problem — typo, type mismatch, missing property. The preview and grid hold their last good state; the status bar shows \"stale\"."}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Red cell in the grid"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["That cell's value doesn't fit its column: not a number, not a valid enum option, an invalid Set/List member, or empty but needed. Only the cards built from that cell's row become placeholders — and if that row makes several copies (",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}],"), the whole group goes together, since they're built from one evaluation."]}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"A grey placeholder card"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"One card's data couldn't be evaluated — a bad cell, a divide by zero, a runaway repeat. The error messages are printed on the card."}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"An amber dot on a card"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["A ",["$","$L5","a-0",{"href":"/docs/text","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]}]," on that card had its text clipped or shrunk to fit the box — not an error, just worth a look."]}]]}],"$L2e","$L2f","$L30"]}]]}]}],"\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d"]}],"$L3e"]}]
2e:["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"A dimmed spreadsheet row"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"A brand-new, never-edited empty row. It's excluded from the deck until you type into it."}]]}]
2f:["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"An icon showing raw text"}]," like ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"HEARTZ"}]]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["An unknown ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"icon code"}]," — on an ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}],", or an ",["$","$L5","a-1",{"href":"/docs/text#inline-icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"inline marker"}]," that rendered as its raw ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{HEARTZ}"}]," text. Fix the spelling."]}]]}]
30:["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Raw text"}]," like ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:damage_icon}"}]]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["D011: the ",["$","$L5","a-0",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"text alias"}]," is unknown, statically non-Text, or could not be prepared as a valid target. The marker stays visible and the card still renders."]}]]}]
31:["$","h2","h2-0",{"id":"two-kinds-of-problem","aria-label":"Two kinds of problem","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Two kinds of problem",["$","a",null,{"href":"#two-kinds-of-problem","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","p","p-2",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Code problems"}]," are found before any data is touched — a syntax error, an unknown\nreference, a type mismatch. They squiggle in the editor. While they're unresolved, the\npreview keeps showing the last render that worked, and the grid keeps the last set of\ncolumns that compiled, so nothing flickers while you're mid-edit."]}]
33:["$","p","p-3",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Data problems"}]," are found while building actual cards — a cell that isn't a number,\nan empty Number/single-Enum cell that a template needs, an invalid collection member,\na ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," that isn't a whole number, a\ncomputed value that breaks (division by zero, a runaway repeat). Most flag the\noffending cell red where there is one and turn the affected cards into\nplaceholders — a row's ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," copies always fail as ONE group, never\nindividually, even when only one of them actually triggered the problem (the\nplaceholder message says which one). Two are deliberately diagnostic-only:\nunknown computed icon code D005 and an unavailable text-alias target D011 leave\ntheir raw text visible on an otherwise rendered card. The rest of the deck renders\nnormally."]}]
34:["$","h2","h2-1",{"id":"warnings","aria-label":"Warnings","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Warnings",["$","a",null,{"href":"#warnings","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","p","p-4",{"className":"my-4","children":"Some things are suspicious rather than wrong, and warn instead of erroring:"}]
36:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," variable shadowing a column name,"]}],"\n",["$","li","li-1",{"children":"a declaration nothing uses,"}],"\n",["$","li","li-2",{"children":["an explicit ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units"}]," that makes units non-square,"]}],"\n",["$","li","li-3",{"children":["an icon code that isn't in the known list — on an ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]," or in an inline\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{marker}"}]," in text — it may still be a real glyph, since the published list\nisn't exhaustive,"]}],"\n",["$","li","li-4",{"children":["an ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:"}]," reference to an upload that isn't in your library — in an ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Image"}],"\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"src:"}]," or an inline ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{asset:name}"}]," marker — you might be about to add it."]}],"\n"]}]
37:["$","p","p-5",{"className":"my-4","children":["A failed ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}]," expansion is a non-fatal D011 data diagnostic rather than a\nwarning: the original marker stays visible and the rest of the card still renders.\nThis applies when the target is unknown, non-Text, or invalid during the compiler's\nalias-preparation pass. A valid Text target that later hits bad row data keeps that\nordinary diagnostic and recovery posture — for example, D003 still produces a\nplaceholder instead of being converted to D011."]}]
38:["$","p","p-6",{"className":"my-4","children":["A top-level let that validly resolves to Text without Card data or for at least one\ndeclared Card is the exception to \"a declaration nothing uses\": it can be named by\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}]," arriving only from spreadsheet data, so it and its global dependencies\nare treated as externally addressable and do not get W002. Invalid or exclusively\nnon-Text lets are not alias exports and keep the ordinary unused-declaration behavior."]}]
39:["$","h2","h2-2",{"id":"composition-problems","aria-label":"Composition problems","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Composition problems",["$","a",null,{"href":"#composition-problems","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3a:["$","p","p-7",{"className":"my-4","children":["Cyclic ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," references and recursive Template calls are E009 errors; the message\nshows the dependency path. Template composition is also bounded per Card face: at\nmost ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"64 active Template calls"}]," and ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"10,000 Template-node visits reached through\ncalls"}],". Crossing either limit is E010 while checking or D010 while building a card.\nThese limits charge composition only: a large call-free legacy Template cannot hit\nthem, and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," share their separate 500-iteration limit."]}]
3b:["$","h2","h2-3",{"id":"recovering","aria-label":"Recovering","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Recovering",["$","a",null,{"href":"#recovering","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3c:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Broken code?"}]," Undo. The preview comes back live the moment the code parses again."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Placeholder cards?"}]," Read the message printed on the card — it names the problem."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Errors after adding a column?"}]," New ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Number"}]," and single-enum cells start empty; empty\ncells that a template references are an error by design, so that missing data is\nvisible rather than silently defaulting to zero. Empty Set/List cells are valid."]}],"\n"]}]
3d:["$","p","p-8",{"className":"my-4","children":["For every code and its recovery posture, see the\n",["$","$L5","a-0",{"href":"/docs/diagnostics","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Diagnostics catalog"}],"."]}]
3e:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/cards-and-generation","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Cards & generation"}]]}],["$","$L5",null,{"href":"/docs/card-sizes","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Card sizes"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3f:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Errors & diagnostics — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"What each kind of error looks like, and why one mistake never blanks a deck."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/errors"}],["$","meta","6",{"property":"og:title","content":"Errors & diagnostics — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"What each kind of error looks like, and why one mistake never blanks a deck."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/errors"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Errors & diagnostics — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"What each kind of error looks like, and why one mistake never blanks a deck."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3f","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
