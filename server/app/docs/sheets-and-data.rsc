...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Sheets & data"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Declaring columns and enums, and how [references] resolve."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Your code declares the ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"shape"}]," of the data; the grid holds the ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"values"}],". That\nsplit is what makes every ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[reference]"}]," checkable as you type."]}],"\n",["$","h2","h2-0",{"id":"declaring-a-sheet","aria-label":"Declaring a sheet","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Declaring a sheet",["$","a",null,{"href":"#declaring-a-sheet","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Sheet: Monsters\n  column name: Text\n  column cost: Number\n  column health: Number\n  column count: Number\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":["Each ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet:"}]," becomes one tab in the spreadsheet panel with exactly these columns.\nColumn types are:"]}],"\n",["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Type"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Cells accept"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Empty cell"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"anything"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["treated as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\"\""}]]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Number"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"numeric values"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"an error if referenced"}]]}],"$L2e","$L2f","$L30"]}]]}]}],"\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41","\n","$L42","\n","$L43","\n","$L44","\n","$L45","\n","$L46","\n","$L47","\n","$L48","\n","$L49","\n","$L4a","\n","$L4b","\n","$L4c","\n","$L4d","\n","$L4e","\n","$L4f","\n","$L50","\n","$L51","\n","$L52","\n","$L53","\n","$L54","\n","$L55","\n","$L56","\n","$L57","\n","$L58","\n","$L59","\n","$L5a","\n","$L5b","\n","$L5c","\n","$L5d","\n","$L5e"]}],"$L5f"]}]
2e:["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","em","em-0",{"children":"any Enum"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"one of that enum's cases (dropdown)"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"an error if referenced"}]]}]
2f:["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"zero or more unique cases (tag chips)"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"valid empty set"}]]}]
30:["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"zero or more ordered cases; duplicates allowed"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"valid empty list"}]]}]
31:["$","p","p-2",{"className":"my-4","children":["A sheet may declare ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"zero columns"}]," — the tab then just holds numbered rows. That's\nthe idiom for decks whose content comes entirely from a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}],"."]}]
32:["$","h3","h3-0",{"id":"editing-the-schema","aria-label":"Editing the schema","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["Editing the schema",["$","a",null,{"href":"#editing-the-schema","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
33:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["Add a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column"}]," line → the column appears in the grid."]}],"\n",["$","li","li-1",{"children":["Remove one → the column disappears, but ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"its data is kept for the session"}],", in\ncase you were mid-typo."]}],"\n",["$","li","li-2",{"children":["Rename one (same position, same type) → the data ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"migrates"}]," with it. Rename the\ncolumn and its ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[references]"}]," together and nothing is lost."]}],"\n"]}]
34:["$","h2","h2-1",{"id":"enums","aria-label":"Enums","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Enums",["$","a",null,{"href":"#enums","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Enum: Suit\n  case Rock\n  case Paper\n  case Scissors\n"}]}]
36:["$","p","p-3",{"className":"my-4","children":"An enum is a named, fixed set of cases. Two uses:"}]
37:["$","ol","ol-0",{"className":"my-4 list-decimal space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"As a column type"}]," — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"column suit: Suit"}]," makes those cells dropdowns, so a cell\ncan never hold a value the code doesn't know about."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"As a generator"}]," — ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop: Suit as current_suit"}]," on a Card produces one card per\ncase. See ",["$","$L5","a-0",{"href":"/docs/cards-and-generation","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Cards and generation"}],"."]}],"\n"]}]
38:["$","p","p-4",{"className":"my-4","children":["Refer to a case as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Suit.Rock"}],". Bare ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Rock"}]," also works wherever the expected type\nmakes it unambiguous — comparing against an enum-typed reference, for instance."]}]
39:["$","h2","h2-2",{"id":"sets-and-lists","aria-label":"Sets and lists","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Sets and lists",["$","a",null,{"href":"#sets-and-lists","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3a:["$","p","p-5",{"className":"my-4","children":"Use a Set for unordered game tags whose display order should stay consistent, and a\nList for a symbol sequence whose order and repetitions matter:"}]
3b:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Enum: CardTag\n  case Armor\n  case Fire\n\nEnum: Mana\n  case Generic4\n  case Blue\n  case Red\n\nSheet: Cards\n  column tags: Set<CardTag>\n  column cost: List<Mana>\n"}]}]
3c:["$","p","p-6",{"className":"my-4","children":["A Set cell never contains the same case twice and displays/iterates in the Enum's\ndeclaration order. A List preserves the cell order, so ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Blue, Blue, Generic4"}]," is\nthree entries. The grid presents both as chips; comma-separated text is their\nclipboard/export representation. Spaces around names are ignored. Unknown cases,\nempty entries such as ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Blue,,Red"}],", and duplicates in a Set flag that cell red while\npreserving what was pasted. Reordering an Enum changes a Set's semantic display and\niteration order but never silently rewrites stored rows."]}]
3d:["$","p","p-7",{"className":"my-4","children":["Use ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"contains([tags], CardTag.Fire)"}]," to test membership and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," to draw every\nmember. Collections do not turn into Text automatically and cannot be compared."]}]
3e:["$","h2","h2-3",{"id":"how-references-resolve","aria-label":"How [references] resolve","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[["How ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[references]"}]," resolve"],["$","a",null,{"href":"#how-references-resolve","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3f:["$","p","p-8",{"className":"my-4","children":["Inside a template, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name]"}]," is looked up in this order, innermost first:"]}]
40:["$","ol","ol-1",{"className":"my-4 list-decimal space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["the nearest enclosing ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],"/",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," variables"]}]," and local ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," values"]}],",\nnearest scope first,"]}],"\n",["$","li","li-1",{"children":["the current Template's ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"parameters"}],","]}],"\n",["$","li","li-2",{"children":["the Card's ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop"}]," variables"]}],","]}],"\n",["$","li","li-3",{"children":["the bound ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"sheet's columns"}],","]}],"\n",["$","li","li-4",{"children":["global ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," values"]}],","]}],"\n",["$","li","li-5",{"children":["the built-in ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"generation bindings"}]," (below)."]}],"\n"]}]
41:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Card: Monster\n  sheet: Monsters              # sheet columns: [name], [cost], [health], [count]\n  loop: Suit as current_suit   # Card loop variable: [current_suit]\n  ...\n\nTemplate: MonsterFront\n  Repeat: [health] as i        # nearest local binding: [i]\n    Icon:\n      x: 1.5 + [i] * 2\n"}]}]
42:["$","p","p-9",{"className":"my-4","children":["Templates are checked ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"per Card that reaches them"}],", including through Template\ncalls, so a template referencing\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[health]"}]," is valid when used by a Card whose sheet has a ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"health"}]," column, and\nsquiggled when used by one that doesn't. A shadowed name (a ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," variable with the\nsame name as a column) still works, innermost-first, but warns."]}]
43:["$","h2","h2-4",{"id":"generation-identity-row-copy-deck-and-project","aria-label":"Generation identity: row, copy, deck, and project","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Generation identity: row, copy, deck, and project",["$","a",null,{"href":"#generation-identity-row-copy-deck-and-project","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
44:["$","p","p-10",{"className":"my-4","children":["These derived bindings are available anywhere a Card context exists, including\nTemplates, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}],", program lets, and virtual columns — no sheet column to declare:"]}]
45:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}]}]," — the row's 1-based position in its sheet. It's exactly the number\nshown (and edited — see ",["$","$L5","a-0",{"href":"/docs/the-editor","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"The editor"}],") in the\ngrid's row gutter, so every card generated from one row shares it."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}]}]," — the card's 1-based position within its ",["$","em","em-0",{"children":"generated deck"}],", counting\nevery ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}]," combination and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," copy. It increments once per physical card."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[copy]"}]}]," — the 1-based copy within the current row × loop combination. It\nresets to 1 for the next combination."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck]"}]}]," — Text containing the current ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," declaration name, such as\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"BlackCards"}]," or ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"WhiteCards"}],"."]}],"\n",["$","li","li-4",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}]}]," — a clearer alias for ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}],"; both always produce the same Number."]}],"\n",["$","li","li-5",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]}]," — the 1-based physical position across all generated ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}],"\nblocks in declaration order."]}],"\n"]}]
46:["$","p","p-11",{"className":"my-4","children":["They only differ once ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"loop:"}]," or ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," turns one row into several cards. Two rows\n(Dragon, Imp) times the demo's three suits:"]}]
47:["$","div","table-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Sheet row"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Suit"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}]}],["$","th","th-3",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}]}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Dragon"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Rock"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Dragon"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Paper"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Dragon"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Scissors"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"1"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"3"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Imp"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Rock"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"4"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Imp"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Paper"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"5"}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Imp"}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Scissors"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"2"}],["$","td","td-3",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"6"}]]}]]}]]}]}]
48:["$","p","p-12",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}]," labels the ",["$","em","em-0",{"children":"data"}],". ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[copy]"}]," distinguishes duplicates of one row/loop result.\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck]"}]," says which Card declaration emitted the instance. ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}],"/",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}],"\nnumber one deck, while ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]," numbers the current generated project."]}]
49:["$","h3","h3-1",{"id":"choosing-a-durable-id","aria-label":"Choosing a durable ID","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["Choosing a durable ID",["$","a",null,{"href":"#choosing-a-durable-id","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
4a:["$","p","p-13",{"className":"my-4","children":["Position numbers change when you reorder rows or Card declarations, add loop cases, or\nchange counts. That makes ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}]," useful for a particular print manifest, but\nnot a durable identity. Prefer a semantic code stored in your sheet and add the variant\nand copy when duplicates must be distinct:"]}]
4b:["$","pre","pre-4",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"text: \"[edition]|[code]|[copy]\"       # durable while those meanings stay stable\ntext: \"[deck]|[deck_card]|[code]\"     # explicit, but deck-position dependent\ntext: \"[project_card]|[code]\"         # unique in this generated project only\n"}]}]
4c:["$","p","p-14",{"className":"my-4","children":["If you need an ID that survives sheet reordering, store it in a column such as ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"code"}],".\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}]," is a visible position, not a hidden persistent row UUID."]}]
4d:["$","p","p-15",{"className":"my-4","children":["All generation bindings are derived, not stored: nothing about them lives in your rows,\nyour autosave, or an exported ",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project file"}]," —\nmoving a row in the grid is what changes what ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}]," (and, downstream, ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}],")\nresolve to for it.\nIf a sheet declares a column with one of these names, that column ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"shadows"}]," the\nbuilt-in of the same name for any Card bound to it (with the usual shadowing warning)\n— existing projects that already used those names keep working unchanged."]}]
4e:["$","h2","h2-5",{"id":"interpolation","aria-label":"Interpolation","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Interpolation",["$","a",null,{"href":"#interpolation","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
4f:["$","p","p-16",{"className":"my-4","children":["Inside a string, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[ref]"}]," substitutes the value:"]}]
50:["$","pre","pre-5",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"text: \"Cost: [cost]\"      # → \"Cost: 5\"\n"}]}]
51:["$","p","p-17",{"className":"my-4","children":["Numbers and enum cases become text automatically here (trailing zeros are trimmed;\nan enum prints its case name). Use ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[["}]," to write a literal opening bracket."]}]
52:["$","h3","h3-2",{"id":"reusable-text-inside-a-cell","aria-label":"Reusable text inside a cell","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["Reusable text inside a cell",["$","a",null,{"href":"#reusable-text-inside-a-cell","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
53:["$","p","p-18",{"className":"my-4","children":["Cell contents are values, not Goblin source, so a cell containing ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[damage_icon]"}],"\nis not interpolated a second time. ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," have one purpose-built way\nto place a shared marker-rich fragment anywhere inside cell text: put the fragment\nin a top-level Text-valued let and write ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:damage_icon}"}]," in the cell. Alias\nexpansion happens after ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text: [column]"}]," resolves and before inline asset, icon, and\ncolor markers are parsed. See the complete\n",["$","$L5","a-0",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"damage-and-swords example"}],", including\none-level expansion and D011 failure behavior."]}]
54:["$","h3","h3-3",{"id":"zero-padding-number-references","aria-label":"Zero-padding Number references","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["Zero-padding Number references",["$","a",null,{"href":"#zero-padding-number-references","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
55:["$","p","p-19",{"className":"my-4","children":["Inside a quoted string, write ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name:0N]"}]," to pad a Number with zeroes to a minimum\nwidth. ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"N"}]," is a decimal width from 1 through 64, written without a leading zero:\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"01"}],", ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"04"}],", and ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"064"}]," are valid formats; ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"00"}],", ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"001"}],", and ",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"065"}]," are not."]}]
56:["$","pre","pre-6",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"text: \"[deck]-[deck_card:03]\"  # BlackCards-007\n\nlet shifted_id: [project_card] + 100\ntext: \"CG-[shifted_id:06]\"     # CG-000107\n"}]}]
57:["$","p","p-20",{"className":"my-4","children":["The width includes a minus sign, and zeroes follow that sign: ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"-7"}]," with ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":":04"}]," becomes\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"-007"}],". Width is only a minimum. A longer value is never truncated, and a fractional\nvalue is never rounded (",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"1.25"}]," with ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":":06"}]," becomes ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"001.25"}],")."]}]
58:["$","p","p-21",{"className":"my-4","children":["This format is Number-only and string-only. A Text or enum reference with ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":":0N"}]," is a\ntype error, and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name:04]"}]," cannot be used as a standalone expression. Ordinary\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[name]"}]," interpolation works exactly as before."]}]
59:["$","h2","h2-6",{"id":"rows","aria-label":"Rows","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Rows",["$","a",null,{"href":"#rows","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
5a:["$","p","p-22",{"className":"my-4","children":"Rows live in the grid, not in your code — editing a cell never rewrites your script.\nTwo rules worth knowing:"}]
5b:["$","ul","ul-2",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Pristine rows are excluded."}]," A row you just added and haven't typed in is dimmed\nand left out of the deck. It joins as soon as you type into it."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Bad cells are local."}]," A cell that doesn't fit its column flags red, and only the\ncards built from that row become placeholders. See\n",["$","$L5","a-0",{"href":"/docs/errors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Errors and diagnostics"}],"."]}],"\n"]}]
5c:["$","h2","h2-7",{"id":"virtual-columns","aria-label":"Virtual columns","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Virtual columns",["$","a",null,{"href":"#virtual-columns","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
5d:["$","p","p-23",{"className":"my-4","children":["Use ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"virtual column name: Type = expression"}]," inside a ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet:"}]," when an exported\nprint manifest needs a computed value that users should not edit. Virtual columns\ndo not appear in the grid or row storage; they are evaluated for each generated card\nand included by ",["$","$L5","a-0",{"href":"/docs/data-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Export Data"}],". Because they run\nin the Card context, formulas can use ordinary columns, loop variables, every\ngeneration binding (",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}],", ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[copy]"}],", ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck]"}],", ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[deck_card]"}],", ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[card]"}],", and\n",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[project_card]"}],"), and program ",["$","code","code-8",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," bindings."]}]
5e:["$","pre","pre-7",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Sheet: Monsters\n  column code: Text\n  virtual column card_code: Text = \"[card]|[code]\"\n"}]}]
5f:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/basics","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Basics & syntax"}]]}],["$","$L5",null,{"href":"/docs/templates-and-shapes","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Templates & shapes"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
60:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Sheets & data — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Declaring columns and enums, and how [references] resolve."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/sheets-and-data"}],["$","meta","6",{"property":"og:title","content":"Sheets & data — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Declaring columns and enums, and how [references] resolve."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/sheets-and-data"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Sheets & data — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Declaring columns and enums, and how [references] resolve."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L60","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
