...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"What is CardGoblin"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"A script plus a spreadsheet becomes a print-at-home deck, live as you type."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["CardGoblin turns ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"a small script + a spreadsheet"}]," into ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"print-at-home cards"}],"."]}],"\n",["$","p","p-1",{"className":"my-4","children":["You describe what a card looks like ",["$","em","em-0",{"children":"once"}],". Your spreadsheet holds the data — one\nrow per monster, spell, or item. CardGoblin generates the whole deck from those two\nthings and re-renders it live as you type."]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"   your script            your spreadsheet\n  (what a card is)        (what's on them)\n         │                        │\n         └────────┬───────────────┘\n                  ▼\n          the whole deck, live\n                  │\n                  ▼\n             print PDF\n"}]}],"\n",["$","h2","h2-0",{"id":"why-it-works-this-way","aria-label":"Why it works this way","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Why it works this way",["$","a",null,{"href":"#why-it-works-this-way","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-2",{"className":"my-4","children":["Card design is mostly repetition. Sixty cards that differ only in a name, a number,\nand an icon are sixty chances to make a copy-paste mistake in a drawing tool. Writing\nthe layout once and the ",["$","em","em-0",{"children":"data"}]," separately means:"]}],"\n",["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Change the layout, every card follows."}]," Move the title, and it moves on all 60."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Change one number, only its cards follow."}]," Editing a cell re-renders only the\ncards generated from that row."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Mistakes stay local."}]," A bad cell turns only the cards generated from its row\ninto labelled placeholders — it never blanks the deck. This is a design rule, not\nan accident: see\n",["$","$L5","a-0",{"href":"/docs/errors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Errors and diagnostics"}],"."]}],"\n"]}],"\n",["$","h2","h2-1",{"id":"what-you-get","aria-label":"What you get","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["What you get","$L2e"]}],"\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37"]}],"$L38"]}]
2e:["$","a",null,{"href":"#what-you-get","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]
2f:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["A ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"language"}]," (",["$","$L5","a-0",{"href":"/docs/basics","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Goblin script"}],") that reads like an outline: indentation\nis structure, ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[brackets]"}]," mean \"look this up in the data\"."]}],"\n",["$","li","li-1",{"children":["A ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"spreadsheet"}]," whose columns are declared by your code, so every reference is\nchecked as you type — a typo like ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[helth]"}]," squiggles immediately."]}],"\n",["$","li","li-2",{"children":["A ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"live preview"}]," of every generated card, and ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"PDF export"}]}]," with\ncut lines and duplex-mirrored backs."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Icons"}]," — 888 game glyphs (dice, suits, dominoes, coins) via the\n",["$","a","a-0",{"href":"https://speakthesky.itch.io/typeface-dicier","target":"_blank","rel":"noreferrer noopener","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Dicier"}]," font."]}],"\n"]}]
30:["$","h2","h2-2",{"id":"where-your-work-lives","aria-label":"Where your work lives","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Where your work lives",["$","a",null,{"href":"#where-your-work-lives","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
31:["$","p","p-3",{"className":"my-4","children":["The public editor does not upload your Goblin script, spreadsheet rows, or uploaded\nimages. Code and rows autosave to this browser's ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"localStorage"}],"; images added through\nthe Assets drawer live in IndexedDB; the current compiled preview is held in memory.\nSee ",["$","$L5","a-0",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Autosave"}]," and\n",["$","$L5","a-1",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Uploaded assets"}]," for the details and limits."]}]
32:["$","p","p-4",{"className":"my-4","children":["Like any web app, your browser may cache CardGoblin's own app code, fonts, and icons\nso pages load efficiently. That ordinary browser cache is not a project backup or a\nsync service. Clearing this site's data can erase your local project, so export a\n",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project file"}]," for anything important."]}]
33:["$","p","p-5",{"className":"my-4","children":["One exception is artwork you reference by an external ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"https://"}]," URL: the browser\nfetches that image from its host, which receives an ordinary web request. Upload an\nimage through Assets when you want the artwork itself stored only in this browser."]}]
34:["$","h2","h2-3",{"id":"who-its-for","aria-label":"Who it's for","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Who it's for",["$","a",null,{"href":"#who-its-for","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","p","p-6",{"className":"my-4","children":"Board game designers making print-and-play prototypes, especially decks with\nstructure — rank × suit, one icon per point of health, a cost that changes a banner's\ncolor. If your deck is 60 cards of the same shape, this pays off fast. If it's 5 cards\nof wildly different art, a drawing tool is probably still the better answer."}]
36:["$","h2","h2-4",{"id":"where-to-go-next","aria-label":"Where to go next","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Where to go next",["$","a",null,{"href":"#where-to-go-next","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","ul","ul-2",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","$L5","a-0",{"href":"/docs/quickstart","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Quickstart"}]}]," — build a real deck in five minutes."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","$L5","a-0",{"href":"/docs/the-editor","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"The editor"}]}]," — what the three panels do."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":["$","$L5","a-0",{"href":"/docs/basics","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Goblin script basics"}]}]," — the language from the ground up."]}],"\n"]}]
38:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","span",null,{}],["$","$L5",null,{"href":"/docs/quickstart","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Quickstart"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
39:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"What is CardGoblin — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"A script plus a spreadsheet becomes a print-at-home deck, live as you type."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/what-is-cardgoblin"}],["$","meta","6",{"property":"og:title","content":"What is CardGoblin — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"A script plus a spreadsheet becomes a print-at-home deck, live as you type."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/what-is-cardgoblin"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"What is CardGoblin — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"A script plus a spreadsheet becomes a print-at-home deck, live as you type."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L39","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
