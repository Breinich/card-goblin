...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"The editor"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"The three panels, the status bar, and how live compiling behaves."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["The editor lives at ",["$","$L5","a-0",{"href":"/editor","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"/editor"}]}],". It first opens a blocking project\nchooser: continue this browser's saved project, create a named project from an\navailable starter, or load a project file. The chooser has no close action until\na project has opened successfully. After that, the workspace has three panels\nand a status bar:"]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"┌────────────────────────┬────────────────────────┐\n│  CODE                  │  PREVIEW               │\n│  your Goblin script,   │  one card, or all of   │\n│  squiggles on errors   │  them — front/back     │\n├────────────────────────┴────────────────────────┤\n│  SPREADSHEET — one tab per Sheet:               │\n│  columns from your code, rows from you          │\n├─────────────────────────────────────────────────┤\n│  9 cards · 0 problems · 0 excluded rows         │\n└─────────────────────────────────────────────────┘\n"}]}],"\n",["$","h2","h2-0",{"id":"code-top-left","aria-label":"Code (top left)","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Code (top left)",["$","a",null,{"href":"#code-top-left","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-1",{"className":"my-4","children":["Your Goblin script, in a real code editor (Monaco) with syntax highlighting and\nautocomplete. Suggestions appear as you type (or on ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Ctrl+Space"}],") and fit where\nyour cursor is: your column names inside ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[brackets]"}],", the properties a block\naccepts, size presets, ",["$","$L5","a-0",{"href":"/docs/colors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"color names"}],", enum cases after a ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"."}],", and\n",["$","$L5","a-1",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"icon codes"}]," inside ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"code:"}]," strings. Inside a ","$L2e"," or\n","$L2f"," string, typing ","$L30"," offers color-scope and\n","$L31","\nhelpers; after ","$L32",", the editor offers top-level lets that the compiler knows\ncan resolve to Text. Suggestions come from your latest compile,\nso they keep working while the code is broken mid-edit — the moment a ","$L33","\ndeclares a column, that column is offered everywhere it's legal. Errors appear as\nred squiggles where they happen, and the status bar counts how many."]}],"\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41","\n","$L42","\n","$L43","\n","$L44","\n","$L45","\n","$L46","\n","$L47"]}],"$L48"]}]
2e:["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]
2f:["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]
30:["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{"}]
31:["$","$L5","a-2",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"resolved-text alias"}]
32:["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:"}]
33:["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet:"}]
34:["$","h2","h2-1",{"id":"preview-top-right","aria-label":"Preview (top right)","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Preview (top right)",["$","a",null,{"href":"#preview-top-right","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","p","p-2",{"className":"my-4","children":["Your generated cards, live. Toggle ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Front/Back"}]," and ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Export PDF"}]," from the\ntoolbar, and pick one of two views with the pair of icon buttons next to them:"]}]
36:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Single card"}]," (the default) — one card, as large as the panel allows. The\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"‹ 3 / 18 ›"}]," control steps through every card in the project, in the order the\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," blocks declare them, so the arrows carry you from the end of one deck\ninto the start of the next. A line above the card says which deck you're in."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Grid"}]," — every card at once, grouped by the ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block that made them, with\na ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"zoom"}]," slider for card size. Long decks scroll."]}],"\n"]}]
37:["$","p","p-3",{"className":"my-4","children":["Turn on ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Row numbers"}]," in either view to place a high-contrast red badge over the\ncurrent card—or every visible grid card—showing the one-based sheet row that\ngenerated it. The setting stays on when you switch views. These badges are preview\naids only and never enter PDF output."]}]
38:["$","p","p-4",{"className":"my-4","children":"The zoom slider only appears in grid view; in single view the card is already\nsized to the panel, so making the panel bigger (drag the divider) is the zoom."}]
39:["$","p","p-5",{"className":"my-4","children":["While your code has errors, the preview ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"freezes on the last good result"}]," and shows\nan amber note saying so, instead of flickering or emptying. This is the single most\nimportant behaviour in the editor: you can break your code mid-thought and still see\nwhat you were working on."]}]
3a:["$","h2","h2-2",{"id":"spreadsheet-bottom","aria-label":"Spreadsheet (bottom)","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Spreadsheet (bottom)",["$","a",null,{"href":"#spreadsheet-bottom","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3b:["$","p","p-6",{"className":"my-4","children":["One tab per ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet:"}]," you declare in code. The ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"columns come from your code"}],"; the\n",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"rows are yours to fill"}],"."]}]
3c:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":"Enum-typed columns become dropdowns."}],"\n",["$","li","li-1",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Set<Enum>"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"List<Enum>"}]," columns become chip editors; Lists also expose\nleft/right controls because their order and duplicates are meaningful."]}],"\n",["$","li","li-2",{"children":["A cell whose value doesn't fit its column flags ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"red"}],"."]}],"\n",["$","li","li-3",{"children":["A brand-new, never-edited empty row renders ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"dimmed"}]," and is excluded from the deck\nuntil you type into it — so adding a row doesn't spray errors before you can fill it\nin."]}],"\n",["$","li","li-4",{"children":"Your data survives schema edits. Rename a column in code (same position, same type)\nand its data comes with it."}],"\n",["$","li","li-5",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Sheets can be renamed from the tab bar."}]," Select a tab and use ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Rename"}],", or\ndouble-click the tab. CardGoblin updates the ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Sheet:"}]," declaration and every\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card"}],"'s ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"sheet:"}]," reference as one edit while preserving the rows. Renaming is\ndisabled while the code is broken, and invalid names or collisions are rejected\nwithout changing the project."]}],"\n",["$","li","li-6",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Columns are resizable."}]," Drag the right edge of a column header, or focus its\nresize handle and use the left/right arrow keys. Turn on ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Wrap text"}]," in the tab\nbar when you want long Text cells (such as card descriptions) to wrap and grow\ntheir rows vertically. Number and enum cells stay single-line, and turning wrapping\noff returns Text cells to the compact single-line view without changing their data."]}],"\n",["$","li","li-7",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"The row number is editable."}]," Click it and type a new position — the row moves\nthere and every row between shifts to make room (typing ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"2"}]," on row 10 of A..J\nyields A J B C D E F G H I; a number ≤ 0 or past the end clamps to the first or last\nrow). Typing something that isn't a number, or the row's own current position,\nleaves the grid untouched. This number is exactly what\n",["$","$L5","a-0",{"href":"/docs/sheets-and-data","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[row]"}]}]," resolves to inside your templates —\nreordering rows in the grid is how you reorder what your cards print."]}],"\n"]}]
3d:["$","h2","h2-3",{"id":"status-bar","aria-label":"Status bar","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Status bar",["$","a",null,{"href":"#status-bar","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3e:["$","p","p-7",{"className":"my-4","children":["Total cards, code problems, flagged cells, and excluded rows — plus a ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"stale"}],"\nindicator when the preview is showing an older render because the current code\ndoesn't compile. To its right sit the editor's project-lifecycle controls:"]}]
3f:["$","ul","ul-2",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Assets"}]," — opens the drawer of images uploaded from your machine (see\n",["$","$L5","a-0",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Uploaded assets"}],"), with a count badge."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export project"}]," — download the whole project as a portable file. To load\none back, choose ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"New / Open Project"}],", then ",["$","strong","strong-2",{"className":"font-semibold text-gray-100","children":"Load project file"}]," — see\n",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Project files"}],"."]}],"\n",["$","li","li-2",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export Data"}]," — download one CSV row per generated card, including virtual\ncolumns — see ",["$","$L5","a-0",{"href":"/docs/data-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Data export"}],"."]}],"\n",["$","li","li-3",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Project name"}]," — shows the active project's editable name. Choose ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Rename"}],"\nto edit it, then ",["$","strong","strong-2",{"className":"font-semibold text-gray-100","children":"Save"}]," or ",["$","strong","strong-3",{"className":"font-semibold text-gray-100","children":"Cancel"}],"."]}],"\n",["$","li","li-4",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"New / Open Project"}]," — returns to the project chooser. Your current project\nremains active unless another project finishes opening."]}],"\n"]}]
40:["$","p","p-8",{"className":"my-4","children":["Sign-in and sign-out are not editor controls. Administrator authentication lives\non ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"/admin"}],"."]}]
41:["$","h2","h2-4",{"id":"the-compile-loop","aria-label":"The compile loop","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["The compile loop",["$","a",null,{"href":"#the-compile-loop","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
42:["$","p","p-9",{"className":"my-4","children":["Everything recompiles about ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"300 ms"}]," after you stop typing. One pass does the whole\npipeline:"]}]
43:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"your code ──► parse ──► check ──► generate ──► preview\nyour rows ──────────────────────────┘\n"}]}]
44:["$","p","p-10",{"className":"my-4","children":"Two rules make it feel stable rather than twitchy:"}]
45:["$","ul","ul-3",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Keep last good."}]," The preview shows the last render that succeeded; the grid's\ntabs and columns come from the last schema that compiled. Neither flickers while\nyou're halfway through typing a block."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Per-card isolation."}]," A data problem affects only the cards that touch it. The\nrest of the deck renders normally."]}],"\n"]}]
46:["$","h2","h2-5",{"id":"saving-your-work","aria-label":"Saving your work","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Saving your work",["$","a",null,{"href":"#saving-your-work","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
47:["$","p","p-11",{"className":"my-4","children":["The editor ",["$","$L5","a-0",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"autosaves"}]," your code and rows to this browser and restores\nthem when you come back — one save slot, one browser. For anything precious, export\na ",["$","$L5","a-1",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"project file"}]," too — it's a proper backup that travels."]}]
48:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/quickstart","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Quickstart"}]]}],["$","$L5",null,{"href":"/docs/basics","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Basics & syntax"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
49:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"The editor — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"The three panels, the status bar, and how live compiling behaves."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/the-editor"}],["$","meta","6",{"property":"og:title","content":"The editor — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"The three panels, the status bar, and how live compiling behaves."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/the-editor"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"The editor — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"The three panels, the status bar, and how live compiling behaves."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L49","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
