...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Project files"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Export your project as a file and import it back — backup, moving machines, and more than one project."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Export project"}]," in the status bar downloads your whole project as a single\nfile. ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"New / Open Project → Load project file"}]," loads one back and asks for an\neditable project name before anything changes. This is how you back a project\nup, move it to another browser or machine, hand it to a friend, or begin a new\nnamed project from an existing file."]}],"\n",["$","h2","h2-0",{"id":"whats-in-the-file","aria-label":"What's in the file","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["What's in the file",["$","a",null,{"href":"#whats-in-the-file","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","p","p-1",{"className":"my-4","children":"Everything the editor would need to pick up where you left off:"}],"\n",["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":"your Goblin script,"}],"\n",["$","li","li-1",{"children":"every sheet's rows — including which rows you've touched, so dimmed pristine\nrows come back dimmed, and including values from columns you've removed\n(they resurface if the column comes back),"}],"\n",["$","li","li-2",{"children":["every ",["$","$L5","a-0",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"uploaded asset"}]," in your Assets drawer — the\nart itself, not a reference to it, so the file is self-contained,"]}],"\n",["$","li","li-3",{"children":"the editable project name when the exporting version supplies one,"}],"\n",["$","li","li-4",{"children":"a format version, so future versions of CardGoblin can keep reading old files."}],"\n"]}],"\n",["$","p","p-2",{"className":"my-4","children":["The code-and-sheets part is the exact same shape\n",["$","$L5","a-0",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"autosave"}]," writes to your browser; assets are the one addition a\nproject ",["$","em","em-0",{"children":"file"}]," carries that the autosave slot doesn't (see\n",["$","$L5","a-1",{"href":"/docs/autosave","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Autosave"}]," for why). Either way it's plain JSON — readable in any\ntext editor, friendly to version control (art included, as base64 text)."]}],"\n",["$","h2","h2-1",{"id":"export","aria-label":"Export","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Export",["$","a",null,{"href":"#export","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n","$L2e","\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38"]}],"$L39"]}]
2e:["$","p","p-3",{"className":"my-4","children":["One click, no options. The file is named after your deck — a project whose code\ndeclares exactly one ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block downloads as ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"<deckname>.cardgoblin.json"}],";\nanything else (several decks, or code too broken to tell) downloads as\n",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"cardgoblin-project.cardgoblin.json"}],"."]}]
2f:["$","p","p-4",{"className":"my-4","children":["Export saves what's in the editor ",["$","em","em-0",{"children":"right now"}],", broken code and all — like\nautosave, it never swaps in some older working version behind your back."]}]
30:["$","p","p-5",{"className":"my-4","children":"If your uploaded images can't be read at that moment (a browser storage\nhiccup), export stops with an error instead of downloading a file without\nthem — a backup silently missing its art isn't a backup."}]
31:["$","h2","h2-2",{"id":"import","aria-label":"Import","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Import",["$","a",null,{"href":"#import","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","p","p-6",{"className":"my-4","children":["Choose ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"New / Open Project"}],", then ",["$","strong","strong-1",{"className":"font-semibold text-gray-100","children":"Choose project file"}],". Two things can happen:"]}]
33:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"The file isn't a readable CardGoblin project"}]," — wrong file, damaged, or\nfrom an incompatible future version. The chooser says so, and your current\nproject is untouched. Import is all-or-nothing: it never half-loads a file\n(a damaged asset entry invalidates the whole file, same as a damaged sheet\nrow)."]}],"\n",["$","li","li-1",{"children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"The file is valid"}]," — the chooser suggests its embedded name (or the file\nname) and lets you edit it. Anonymous users replacing their active browser\nproject receive an inline two-step warning and should export first if they\nstill need that project. Signed-in administrators create a new cloud project;\nthey do not overwrite an arbitrary existing one."]}],"\n"]}]
34:["$","p","p-7",{"className":"my-4","children":["After content and assets have both been written and read back successfully, one\nsmall active-project pointer changes and the import becomes live. A failure\nleaves the project you were editing untouched. Reloading offers the new browser\nproject through ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Continue browser project"}],"."]}]
35:["$","h3","h3-0",{"id":"older-files-still-import","aria-label":"Older files still import","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["Older files still import",["$","a",null,{"href":"#older-files-still-import","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
36:["$","p","p-8",{"className":"my-4","children":"A file exported before uploaded assets existed has no art in it. Current v1\nand v2 files still import, including grandfathered image MIME types, empty\nassets, and long asset names that the older local library permitted. Those\nlegacy assets remain recoverable and exportable locally; new uploads use the\ncurrent reviewed image policy."}]
37:["$","h2","h2-3",{"id":"more-than-one-project","aria-label":"More than one project","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["More than one project",["$","a",null,{"href":"#more-than-one-project","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
38:["$","p","p-9",{"className":"my-4","children":["Anonymous editing keeps one active browser project and portable files remain\nthe backup/move boundary. Administrators authenticated at ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"/admin"}]," also see a\nnamed cloud-project list in the chooser and can return to those projects from\nanother device."]}]
39:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/autosave","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Autosave"}]]}],["$","$L5",null,{"href":"/docs/assets","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Uploaded assets"}]]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
3a:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Project files — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Export your project as a file and import it back — backup, moving machines, and more than one project."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/project-files"}],["$","meta","6",{"property":"og:title","content":"Project files — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Export your project as a file and import it back — backup, moving machines, and more than one project."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/project-files"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Project files — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Export your project as a file and import it back — backup, moving machines, and more than one project."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L3a","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
