...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Diagnostics catalog"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Every E, W, and D code, what it means, and whether the affected card still renders."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":"Every problem CardGoblin reports carries a code. The prefix tells you when it was\nfound and what happens next:"}],"\n",["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Prefix"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"When it is raised"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"What you see"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Compiling code, before row data is evaluated"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Red squiggle; preview and grid keep their last good result"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Compiling code; suspicious but not fatal"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Warning squiggle; rendering continues"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Generating actual cards from rows"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Red cell, diagnostic, placeholder, or truncation as listed below"}]]}]]}]]}]}],"\n",["$","p","p-1",{"className":"my-4","children":["Internal fallback codes ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E000"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D000"}]," may appear if CardGoblin itself cannot\nclassify an unexpected compiler or generation failure. They are not mistakes users\nare expected to target directly; preserve the project and report the message."]}],"\n",["$","h2","h2-0",{"id":"compile-errors","aria-label":"Compile errors","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Compile errors","$L2e"]}],"\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37"]}],"$L38"]}]
2e:["$","a",null,{"href":"#compile-errors","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]
2f:["$","div","table-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Code"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Meaning"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Usual fix"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E001"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Syntax error, including malformed interpolation"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Fix the highlighted spelling, delimiter, indentation, or expression"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E002"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Unknown sheet, Template, enum, column, variable, or other reference"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Correct the name or declare it in the reachable scope"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E003"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Type mismatch, including a value that cannot be interpolated"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Supply the type required by that property or expression"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E004"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Bare enum case cannot be resolved from context"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Qualify it, for example ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Suit.Rock"}]]}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E005"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Duplicate declaration, column, enum case, argument, or property"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Keep one unique declaration/value"}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E007"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Contextual keyword used where it is not legal"}],"$L39"]}],"$L3a","$L3b","$L3c"]}]]}]}]
30:["$","p","p-2",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E006"}]," is intentionally retired. Unknown literal icon codes were downgraded to\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W004"}]," because Dicier's curated code list is not exhaustive."]}]
31:["$","h2","h2-1",{"id":"compile-warnings","aria-label":"Compile warnings","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Compile warnings",["$","a",null,{"href":"#compile-warnings","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","div","table-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Code"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Meaning"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Usual fix"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W001"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"A binding shadows another binding"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Rename one when the overlap is accidental"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W002"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"A declaration is unused"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Remove it or reference it; top-level lets that validly resolve to Text as alias targets, and their global dependencies, are exempt"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W003"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Explicit ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units"}]," makes units non-square"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Prefer ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"y_units: auto"}]," unless stretching is deliberate"]}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W004"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Literal ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]," code or inline Dicier marker is not in the known list"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Check the spelling; it may still be a valid uncatalogued glyph"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"W005"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Literal ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"asset:"}]," image or inline asset marker is not in the current Assets library"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Upload it or correct the asset name"}]]}]]}]]}]}]
33:["$","p","p-3",{"className":"my-4","children":"Warnings never replace a card with a placeholder."}]
34:["$","h2","h2-2",{"id":"data-diagnostics","aria-label":"Data diagnostics","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Data diagnostics",["$","a",null,{"href":"#data-diagnostics","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
35:["$","p","p-4",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D001"}],"–",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D003"}]," identify a source cell, flag it red, and replace every affected card\nwith a labelled placeholder. The other codes have no single source cell and use the\nposture stated in the table."]}]
36:["$","div","table-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Code"}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Meaning"}],["$","th","th-2",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Result"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D001"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Cell value is not valid for its enum type: an unknown case, or a Set/List with an unknown or empty item or duplicate Set member"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected cards become placeholders"}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D002"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Cell is not numeric in a Number column"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected cards become placeholders"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D003"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"An edited row has an empty Number or single-enum cell that generated content needs; empty Sets/Lists are valid"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected cards become placeholders"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D004"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}]," count is negative/non-integer, or the shared ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Repeat"}],"/",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"ForEach"}]," budget exceeds 500 iterations"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected card becomes a placeholder; no partial face is kept"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D005"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["A computed ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]," code or inline marker is unknown"]}],"$L3d"]}],"$L3e","$L3f","$L40","$L41","$L42","$L43"]}]]}]}]
37:["$","p","p-5",{"className":"my-4","children":["See ",["$","$L5","a-0",{"href":"/docs/errors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Errors & diagnostics"}]," for how these states look\nin the editor and how last-good preview behavior protects the rest of the deck. Data\nerrors raised while evaluating an otherwise valid Text alias keep their own code and\nresult (for example, D003 still makes a placeholder); they are not remapped to D011."]}]
38:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/icons","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Icons"}]]}],["$","$L5",null,{"href":"/docs/pdf-export","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"PDF export"}]]}]]}]
39:["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Use the keyword only in its supported property or axis"}]
3a:["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E008"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Required property is missing or invalid, or a preset is unknown"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Add/fix the named ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card"}]," or shape property"]}]]}]
3b:["$","tr","tr-7",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E009"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Cyclic ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," dependency or Template-call dependency"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Break the dependency path printed in the message"}]]}]
3c:["$","tr","tr-8",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"E010"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Template composition exceeds 64 active calls or 10,000 call-reached nodes per Card face"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Remove recursion or flatten/reduce the composition graph"}]]}]
3d:["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Diagnostic only; the failed ligature/raw marker remains visible"}]
3e:["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D006"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"count:"}]," is negative, non-integer, or cannot be evaluated"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"One placeholder for that row × loop-case combination"}]]}]
3f:["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D007"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["One ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Card:"}]," block exceeds 2,000 physical instances"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"That block is truncated and generation continues"}]]}]
40:["$","tr","tr-7",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D008"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Numeric evaluation is non-finite, such as division by zero"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected card becomes a placeholder"}]]}]
41:["$","tr","tr-8",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D009"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"QR data exceeds the selected error-correction level's maximum capacity"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected card becomes a placeholder"}]]}]
42:["$","tr","tr-9",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D010"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Runtime Template composition exceeds 64 active calls or 10,000 call-reached nodes for one face/copy"}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Affected card becomes a placeholder"}]]}]
43:["$","tr","tr-10",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"D011"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["A ",["$","$L5","a-0",{"href":"/docs/text#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"resolved-text alias"}]," has no top-level target, has a statically non-Text target, or could not be prepared as a valid target"]}],["$","td","td-2",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["Diagnostic only; the raw ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}]," marker stays visible and the card renders"]}]]}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
44:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Diagnostics catalog — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Every E, W, and D code, what it means, and whether the affected card still renders."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/diagnostics"}],["$","meta","6",{"property":"og:title","content":"Diagnostics catalog — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Every E, W, and D code, what it means, and whether the affected card still renders."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/diagnostics"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Diagnostics catalog — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Every E, W, and D code, what it means, and whether the affected card still renders."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L44","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
