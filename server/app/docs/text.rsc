...
24:["$","article",null,{"children":[["$","header",null,{"className":"mb-8 border-b border-gray-800 pb-6","children":[["$","div",null,{"className":"mb-3 flex flex-wrap items-center gap-3","children":[["$","h1",null,{"className":"text-3xl font-extrabold tracking-tight text-white","children":"Text & TextBox"}],["$","span",null,{"title":"This part of CardGoblin is settled — expect it to keep working.","className":"inline-block rounded-full border px-2 py-0.5 text-xs font-medium border-teal-700 bg-teal-950 text-teal-300 ","children":"Stable"}]]}],["$","p",null,{"className":"text-gray-400","children":"Single-line and wrapped text, reusable aliases, inline icons, colors, and fonts."}]]}],["$","div",null,{"className":"text-[15px] leading-7 text-gray-300","children":[["$","p","p-0",{"className":"my-4","children":["Two elements put words on a card: ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," for one line, ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," when it needs to\nwrap inside a box."]}],"\n",["$","h2","h2-0",{"id":"text-one-line","aria-label":"Text — one line","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," — one line"],["$","a",null,{"href":"#text-one-line","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Text: \"Title\"\n  x: middle\n  y: 0.7\n  size: 1.6\n  text: [name]\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x y size text"}]," are required; ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color"}]," (default ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"black"}],"), ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot"}]," (default\n",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"top_left"}],"), and ",["$","code","code-5",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate"}]," (default ",["$","code","code-6",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"0"}],") are optional. ",["$","code","code-7",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," always draws a single line — ",["$","code","code-8",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size"}]," is the text's\nheight in units, not a font-size number. However long the resolved text is, it\nkeeps going in one line rather than wrapping; when it needs to fill an area\ninstead, that's ",["$","code","code-9",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],", below. A newline character in the resolved text (from\ncell data, say) renders as a space in ",["$","code","code-10",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," — hard breaks are a ","$L2e","\nfeature."]}],"\n","$L2f","\n","$L30","\n","$L31","\n","$L32","\n","$L33","\n","$L34","\n","$L35","\n","$L36","\n","$L37","\n","$L38","\n","$L39","\n","$L3a","\n","$L3b","\n","$L3c","\n","$L3d","\n","$L3e","\n","$L3f","\n","$L40","\n","$L41","\n","$L42","\n","$L43","\n","$L44","\n","$L45","\n","$L46","\n","$L47","\n","$L48","\n","$L49","\n","$L4a","\n","$L4b","\n","$L4c","\n","$L4d","\n","$L4e","\n","$L4f","\n","$L50","\n","$L51","\n","$L52","\n","$L53","\n","$L54","\n","$L55","\n","$L56","\n","$L57","\n","$L58","\n","$L59","\n","$L5a","\n","$L5b","\n","$L5c","\n","$L5d"]}],"$L5e"]}]
2e:["$","code","code-11",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]
2f:["$","p","p-2",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot:"}]," follows the same nine-point vocabulary every shape uses, and\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate:"}]," turns the line around that pivot point, in degrees clockwise — see\n",["$","$L5","a-0",{"href":"/docs/templates-and-shapes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Pivots"}]," on Templates & shapes."]}]
30:["$","p","p-3",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}]," picks the typeface — ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"geist"}]," (the default) or one of eight bundled serif\nand monospace faces. See ",["$","$L5","a-0",{"href":"#fonts","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Fonts"}]," below for the full list."]}]
31:["$","h2","h2-1",{"id":"textbox-wrapped-multi-line-text","aria-label":"TextBox — wrapped, multi-line text","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":[[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," — wrapped, multi-line text"],["$","a",null,{"href":"#textbox-wrapped-multi-line-text","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
32:["$","p","p-4",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," draws one line, always. When a description, a rules paragraph, or flavor\ntext needs to ",["$","em","em-0",{"children":"fill an area"}],", that's ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],":"]}]
33:["$","pre","pre-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"TextBox: \"Rules\"\n  x: 2\n  y: 14\n  width: 16\n  height: 8\n  size: 1.1\n  text: [rules]\n"}]}]
34:["$","p","p-5",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"width:"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"height:"}]," declare a box; the text wraps to fit the width, breaking at\nspaces. A single word wider than the box breaks mid-word rather than poke out the\nside. The wrapping happens ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"at generation time, in the compiler"}]," — the preview\nand the ",["$","$L5","a-0",{"href":"/docs/pdf-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"exported PDF"}]," show the exact same line breaks, always."]}]
35:["$","ul","ul-0",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"align: left | middle | right"}]," places each line within the box's width\n(default ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"left"}],"). It's independent of ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"pivot:"}],", which moves the box itself —\nand ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"x: middle"}]," is an error on TextBox, same as on Rectangle."]}],"\n",["$","li","li-1",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"line_height:"}]," is a multiplier on ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size"}]," for the distance between baselines.\nThe default is ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"1.3"}]," × size; it must be a plain positive number, not an\nexpression."]}],"\n",["$","li","li-2",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}]," picks the typeface — see ",["$","$L5","a-0",{"href":"#fonts","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Fonts"}]," below. Because wrapping\nmeasures actual letterforms, the SAME text in the SAME box can wrap onto a\ndifferent number of lines depending on ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}],"."]}],"\n",["$","li","li-3",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"rotate:"}]," (default ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"0"}],") turns the whole box around its pivot point, in\ndegrees clockwise — see ",["$","$L5","a-0",{"href":"/docs/templates-and-shapes","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Rotation"}]," on Templates &\nshapes. It's paint-only: the text wraps against the box's unrotated width,\nexactly as if the box weren't rotated."]}],"\n"]}]
36:["$","h3","h3-0",{"id":"line-breaks-you-write-yourself","aria-label":"Line breaks you write yourself","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["Line breaks you write yourself",["$","a",null,{"href":"#line-breaks-you-write-yourself","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
37:["$","p","p-6",{"className":"my-4","children":["Wrapping is automatic, but you can also break lines exactly where you want —\na ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"hard break"}]," happens wherever a real newline character appears in the text:"]}]
38:["$","ul","ul-1",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":["\n",["$","p","p-0",{"className":"my-4","children":["In a string literal, write ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\\n"}],":"]}],"\n",["$","pre","pre-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"text: \"Costs [cost].\\n\\nDiscard after use.\"\n"}]}],"\n",["$","p","p-1",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\\n"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\\\\"}]," (a literal backslash) are the ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"only"}]," backslash escapes — any\nother ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"\\"}],"-sequence is an error that names the two valid ones."]}],"\n"]}],"\n",["$","li","li-1",{"children":["\n",["$","p","p-0",{"className":"my-4","children":["Straight from a cell: if a spreadsheet cell contains newline characters\n(pasted or ",["$","$L5","a-0",{"href":"/docs/project-files","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"imported"}]," multi-line content), those break lines\ntoo. No escaping involved — the newline is data."]}],"\n"]}],"\n"]}]
39:["$","p","p-7",{"className":"my-4","children":["Hard breaks always win: they apply before wrapping, and two in a row make an\nempty line. In single-line ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}],", newline characters render as ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"spaces"}]," —\nhard breaks belong to ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],"."]}]
3a:["$","h3","h3-1",{"id":"when-the-text-doesnt-fit","aria-label":"When the text doesn't fit","className":"group scroll-mt-24 mb-2 mt-8 text-lg font-semibold text-white","children":["When the text doesn't fit",["$","a",null,{"href":"#when-the-text-doesnt-fit","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
3b:["$","p","p-8",{"className":"my-4","children":["Wrapping handles width. If the wrapped text is too ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"tall"}]," for the box,\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"overflow:"}]," decides what happens:"]}]
3c:["$","div","table-0",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"overflow"}]}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"What it does"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"clip"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["keep the declared size, drop the lines that don't fit — ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"the default"}]]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"shrink"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["reduce the text size in 5% steps until everything fits, down to a floor of ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"60%"}]," of the declared size — then clip at the floor"]}]]}]]}]]}]}]
3d:["$","p","p-9",{"className":"my-4","children":["Neither is an error — a long description is data, not a mistake. But the preview\ntells you: a card whose text was clipped or shrunk gets a small ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"amber dot"}]," in\nits top-right corner, so an overflowing box can't slip through to print\nunnoticed. Fixing it is a design choice: a bigger box, a smaller ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size:"}],", a\ntighter ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"line_height:"}],", ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"overflow: shrink"}],", or shorter text."]}]
3e:["$","p","p-10",{"className":"my-4","children":["The element's ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}]," sets the whole box at once. For differently colored words\ninside it, use a scoped color below. Interpolation (",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text: \"[name]: [rules]\""}],")\nsubstitutes before wrapping, so mixed cell data wraps as one paragraph. Icons can\nsit inline in the text too; bold and italic runs are still a\n",["$","$L5","a-0",{"href":"/docs/roadmap","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"roadmap"}]," topic."]}]
3f:["$","h2","h2-2",{"id":"reusing-resolved-text-with-aliases","aria-label":"Reusing resolved text with aliases","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Reusing resolved text with aliases",["$","a",null,{"href":"#reusing-resolved-text-with-aliases","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
40:["$","p","p-11",{"className":"my-4","children":["When the same marker-rich fragment belongs in several sheet cells, put it in a\ntop-level Text-valued ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let"}]," and insert it with ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}],":"]}]
41:["$","pre","pre-2",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"let damage_icon: \"{color:#cc2222}{asset:swords}{/color}\"\n\nSheet: Attacks\n  column desc: Text\n\nTemplate: Front\n  TextBox: \"Rules\"\n    x: 2\n    y: 14\n    width: 16\n    height: 4\n    size: 1.1\n    text: [desc]\n"}]}]
42:["$","p","p-12",{"className":"my-4","children":["Then type this in one ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"desc"}]," spreadsheet cell:"]}]
43:["$","pre","pre-3",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Deal 2 {alias:damage_icon}.\n"}]}]
44:["$","p","p-13",{"className":"my-4","children":["Aliases are part of ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"resolved text"}],", not string interpolation. After the\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text:"}]," expression has resolved, each alias can expand a program-level\n",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"let name:"}]," that successfully resolves to Text for that card. ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"name"}]," follows the\nordinary declaration-name rules: a letter, then letters, digits, or underscores.\nThe same syntax therefore works when ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:damage_icon}"}]," comes from a\nspreadsheet cell. Ordinary\n",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[damage_icon]"}]," interpolation cannot do this arbitrary placement: interpolation\nis parsed in source strings, not by rescanning the contents of a cell."]}]
45:["$","p","p-14",{"className":"my-4","children":["Expansion happens ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"exactly one level"}],", and then the ordinary scoped-color,\nDicier, and asset markers are parsed. Those markers can live inside the let's\nvalue, but another ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:other}"}]," produced by that value is not expanded and\nstays visible as raw text. Local lets and Template parameters are not alias\ntargets. ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{{alias:name}"}]," writes the literal text ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}],", following the\nsame doubled-brace escape as other markers."]}]
46:["$","p","p-15",{"className":"my-4","children":["An unknown name, a top-level let whose static type is not Text, or a binding the\ncompiler could not prepare as a valid alias target leaves the original\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{alias:name}"}]," visible. It reports the non-fatal data diagnostic\n",["$","$L5","a-0",{"href":"/docs/errors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"D011"}],", but the card still renders rather than becoming a placeholder."]}]
47:["$","p","p-16",{"className":"my-4","children":"D011 is only about finding and preparing the target. Once a binding is a valid\nText alias, evaluating it uses the ordinary data-error rules. For example, if its\nvalue reads an empty required Number cell, that remains D003 and the affected card\nbecomes a placeholder; it does not turn into raw alias text plus D011."}]
48:["$","p","p-17",{"className":"my-4","children":["A top-level let that validly resolves to Text without Card data, or for at least\none declared Card, is externally addressable even when no literal alias marker\nappears in code: its name may arrive from cell data. It — and the global lets it\ndepends on — therefore does not receive the ordinary W002 \"never used\" warning.\nThis exemption does not rewrite the cell or add anything to\n",["$","$L5","a-0",{"href":"/docs/data-export","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Export Data"}],"; it only makes the let\navailable while rendering ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],"."]}]
49:["$","h2","h2-3",{"id":"scoped-colors","aria-label":"Scoped colors","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Scoped colors",["$","a",null,{"href":"#scoped-colors","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
4a:["$","p","p-18",{"className":"my-4","children":["Both ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," can recolor part of their resolved text:"]}]
4b:["$","pre","pre-4",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"TextBox: \"Rules\"\n  x: 2\n  y: 14\n  width: 16\n  height: 8\n  size: 1.1\n  color: black\n  text: \"Gain {color:gold}2 treasure{/color}, then take {color:crimson}1 damage{/color}.\"\n"}]}]
4c:["$","p","p-19",{"className":"my-4","children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{color:red}"}]," starts a scope and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{/color}"}]," ends it. Use any CSS color name or a\nsix-digit hex value such as ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{color:#cc0000}"}],". Scopes nest; closing an inner scope\nrestores the outer color, and closing the outermost restores the element's own\n",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"color:"}],". The tags are paint-only: they occupy no width, do not cause a wrap boundary,\nand do not change alignment, ",["$","code","code-4",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"line_height:"}],", or overflow calculations."]}]
4d:["$","p","p-20",{"className":"my-4","children":"Scopes apply after interpolation, including when the tags arrive from a spreadsheet\ncell. They also color Dicier markers and multiply-tint inline asset markers:"}]
4e:["$","pre","pre-5",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"text: \"Pay {color:teal}{HEARTS} {asset:energy}{/color} to activate.\"\n"}]}]
4f:["$","p","p-21",{"className":"my-4","children":"Outside a scope, Dicier markers inherit the element's whole-text color and asset art\nkeeps its original colors. Inside one, a white asset becomes the scoped color while\nits transparency and dark detail are preserved. Malformed, unknown-color,\nunbalanced, or unclosed tags stay visible as raw text and produce no diagnostic — the\nsame gentle behavior as other unrecognized brace markers."}]
50:["$","h2","h2-4",{"id":"inline-icons","aria-label":"Inline icons","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Inline icons",["$","a",null,{"href":"#inline-icons","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
51:["$","p","p-22",{"className":"my-4","children":["Both ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," can draw icons ",["$","em","em-0",{"children":"inside"}]," the text, with brace markers:"]}]
52:["$","pre","pre-6",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Text: \"Cost\"\n  x: 1\n  y: 1\n  size: 1.2\n  text: \"Pay {HEARTS} or discard {asset:skull}\"\n"}]}]
53:["$","ul","ul-2",{"className":"my-4 list-disc space-y-1.5 pl-6 marker:text-gray-600","children":["\n",["$","li","li-0",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{HEARTS}"}]," draws the ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"Dicier icon"}]," with that code — uppercase\nletters, digits, underscores (and the one code with a space) between braces."]}],"\n",["$","li","li-1",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{asset:skull}"}]," draws an ",["$","$L5","a-0",{"href":"/docs/assets","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"uploaded asset"}]," by name, exactly the\nnames the Assets drawer holds."]}],"\n",["$","li","li-2",{"children":[["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{{"}]," is a literal ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"{"}],". A lone ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"}"}]," is just a ",["$","code","code-3",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"}"}],". Anything else in braces —\nlowercase, empty, unclosed — isn't a marker and stays ordinary text, no\nwarning."]}],"\n"]}]
54:["$","p","p-23",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Every icon occupies a square one-em slot"}],": as wide and tall as the text's\n",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"size"}],", sitting on the line. Dicier icons draw in the current element/scoped\ncolor; asset art keeps its own colors unless enclosed by a color scope, and\nletterboxes into the slot if it isn't square. For now inline Dicier icons always use the default ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"flat_dark"}]," face —\nthe ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"style:"}]," choice that ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]}]," has doesn't reach inline markers\nyet."]}]
55:["$","p","p-24",{"className":"my-4","children":["Markers are read from the ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"resolved"}]," text — after ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"[column]"}]," interpolation\nand one-level ",["$","$L5","a-0",{"href":"#reusing-resolved-text-with-aliases","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"alias expansion"}]," — so a\nmarker can come straight from a spreadsheet cell (",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"text: [effect]"}]," where the\ncell says ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Take {1_ON_D6} damage"}],"), and data-driven icons work with no extra\nsyntax."]}]
56:["$","p","p-25",{"className":"my-4","children":["In a ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}],", a marker wraps like a word: it moves to the next line whole,\nnever splitting its slot, and the spaces around it collapse at a line break\nexactly like word wrap."]}]
57:["$","p","p-26",{"className":"my-4","children":["Mistakes stay gentle, the same way icon codes and asset names already work:\nan unknown Dicier code written literally in the code warns\n(",["$","$L5","a-0",{"href":"/docs/errors","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":"W004"}],"), an unknown asset name warns (W005), and an unknown code\narriving from cell data is noted at generation time (D005) while the marker\nrenders as its raw text — the failure is its own indicator, and one bad\nmarker never blanks a card."]}]
58:["$","h2","h2-5",{"id":"fonts","aria-label":"Fonts","className":"group scroll-mt-24 mb-3 mt-10 border-b border-gray-800 pb-2 text-2xl font-bold text-white","children":["Fonts",["$","a",null,{"href":"#fonts","aria-label":"Link to this section","className":"ml-2 text-gray-600 opacity-0 transition-opacity group-hover:opacity-100","children":"#"}]]}]
59:["$","p","p-27",{"className":"my-4","children":["Both ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Text"}]," and ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," take an optional ",["$","code","code-2",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}]," — nine bundled faces, picked\nby name:"]}]
5a:["$","pre","pre-7",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800 bg-gray-950 p-4 font-mono text-[13px] leading-6 text-gray-300","children":["$","code","code-0",{"className":"font-mono","children":"Text: \"Title\"\n  x: middle\n  y: 0.7\n  size: 1.6\n  font: garamond_bold\n  text: [name]\n"}]}]
5b:["$","div","table-1",{"className":"my-5 overflow-x-auto rounded-lg border border-gray-800","children":["$","table",null,{"className":"w-full border-collapse text-sm","children":[["$","thead","thead-0",{"className":"bg-gray-800/60","children":["$","tr","tr-0",{"children":[["$","th","th-0",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}]}],["$","th","th-1",{"className":"border-b border-gray-800 px-3 py-2 text-left font-semibold text-gray-200","children":"Face"}]]}]}],["$","tbody","tbody-0",{"children":[["$","tr","tr-0",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"geist"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["the app's clean sans-serif — ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"the default"}]]}]]}],["$","tr","tr-1",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"garamond"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Cormorant Garamond, an elegant serif — regular"}]]}],["$","tr","tr-2",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"garamond_bold"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Cormorant Garamond — bold"}]]}],["$","tr","tr-3",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"garamond_italic"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Cormorant Garamond — italic"}]]}],["$","tr","tr-4",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"garamond_bold_italic"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Cormorant Garamond — bold italic"}]]}],["$","tr","tr-5",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"courier"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Courier Prime, a typewriter monospace — regular"}]]}],["$","tr","tr-6",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"courier_bold"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Courier Prime — bold"}]]}],["$","tr","tr-7",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"courier_italic"}]}],["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Courier Prime — italic"}]]}],["$","tr","tr-8",{"children":[["$","td","td-0",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"$L5f"}],"$L60"]}]]}]]}]}]
5c:["$","p","p-28",{"className":"my-4","children":["Like ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"style:"}]," on ",["$","$L5","a-0",{"href":"/docs/icons","className":"text-teal-400 underline decoration-teal-800 underline-offset-2 hover:text-teal-300","children":["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"Icon"}]}],", this is a ",["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"closed list"}],": an unrecognized\nvalue is an error, not a warning. It's a deliberately small, fixed set for\nnow — two typefaces bundled with the app, not a general font-upload system —\nchosen to cover a serif and a monospace need without opening a whole asset\npipeline. If you need a font that isn't here, that's currently out of reach."]}]
5d:["$","p","p-29",{"className":"my-4","children":[["$","strong","strong-0",{"className":"font-semibold text-gray-100","children":"Wrapping is measured per font."}]," ",["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"TextBox"}]," wraps by measuring each font's own\nletterforms, so the SAME text in the SAME box can break onto different lines\ndepending on ",["$","code","code-1",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"font:"}]," — Courier's fixed-width letters and Cormorant Garamond's\nnarrower serif shapes don't take up the same room per character. There's\nnothing to configure for this; it's why the wrapping stays correct — and the\npreview matches the exported PDF exactly — no matter which face a box uses."]}]
5e:["$","nav",null,{"className":"mt-14 grid gap-3 border-t border-gray-800 pt-6 sm:grid-cols-2","aria-label":"Page navigation","children":[["$","$L5",null,{"href":"/docs/templates-and-shapes","className":"rounded-lg border border-gray-800 px-4 py-3 hover:border-gray-600 hover:bg-gray-800/40","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"← Previous"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Templates & shapes"}]]}],["$","$L5",null,{"href":"/docs/images","className":"rounded-lg border border-gray-800 px-4 py-3 text-right hover:border-gray-600 hover:bg-gray-800/40 sm:col-start-2","children":[["$","span",null,{"className":"block text-xs uppercase tracking-wider text-gray-500","children":"Next →"}],["$","span",null,{"className":"mt-1 block font-medium text-teal-400","children":"Images"}]]}]]}]
5f:["$","code","code-0",{"className":"rounded bg-gray-800 px-1.5 py-0.5 font-mono text-[13px] text-teal-300","children":"courier_bold_italic"}]
60:["$","td","td-1",{"className":"border-b border-gray-800/60 px-3 py-2 align-top","children":"Courier Prime — bold italic"}]
2a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
26:null
61:I[622,[],"IconMark"]
28:{"metadata":[["$","title","0",{"children":"Text & TextBox — Card Goblin docs"}],["$","meta","1",{"name":"description","content":"Single-line and wrapped text, reusable aliases, inline icons, colors, and fonts."}],["$","meta","2",{"name":"application-name","content":"Card Goblin"}],["$","meta","3",{"name":"keywords","content":"board game design,print and play,card generator,custom playing cards,card game prototype,print-at-home PDF cards,tabletop game design tool"}],["$","meta","4",{"name":"robots","content":"index, follow"}],["$","link","5",{"rel":"canonical","href":"https://www.cardgoblin.com/docs/text"}],["$","meta","6",{"property":"og:title","content":"Text & TextBox — Card Goblin docs"}],["$","meta","7",{"property":"og:description","content":"Single-line and wrapped text, reusable aliases, inline icons, colors, and fonts."}],["$","meta","8",{"property":"og:url","content":"https://www.cardgoblin.com/docs/text"}],["$","meta","9",{"property":"og:type","content":"article"}],["$","meta","10",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","11",{"name":"twitter:title","content":"Text & TextBox — Card Goblin docs"}],["$","meta","12",{"name":"twitter:description","content":"Single-line and wrapped text, reusable aliases, inline icons, colors, and fonts."}],["$","link","13",{"rel":"icon","href":"/icon.svg?5701f3d584d9a60c","type":"image/svg+xml","sizes":"any"}],["$","$L61","14",{}]],"error":null,"digest":"$undefined"}
2d:"$28:metadata"
